    ...
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="item_img"><img src="Audio/863_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_863_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                $b_cust_spec=array('Front End 90 - 107','BRG. 1 90 - 107','BRG. 2 90 - 107','BRG. 3 90 - 107','BRG. 4 90 - 107','BRG. 5 90 - 107','REAR END 90-107','Adjacent dimeter 107 max','Data Matrix 90 - 107','Collar 1 110 max');
...
<!--                                <td class="mytdstyle">90 - 107</td>-->
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="10">ROCKWELL HARDNESS-B Scale( HRB)At 2 mm from Cast Surface(98.5 ± 8.5 HRB)</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/863_cam.png" style="" class=" " width="400"></div></th>
