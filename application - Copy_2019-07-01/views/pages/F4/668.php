...
<?php  $action = array('45', '5.5', '45', '5.5', '45','5.5','40','5','40','5','40','5');
$action2 = array('180', '180', '180', '180','180','180','180','229');
$action3 = array('230', '230', '230', '230','230','230','230','302');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="668"  style=" display: none;">
...
<!--// Page Data--->
<div id="668_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_668_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="668_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - 1.4 DICR Ex. (Item 0668) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_668_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="668" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,CHILL DEPTH,A,CHILL DEPTH,B,CHILL DEPTH,C,CHILL DEPTH,D,CHILL DEPTH,E,CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="2797 0510 79 02" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/160/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/668_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_668_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk2= array_chunk((array_slice($b_val, 42, 53)), 12);
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','CHILL DEPTH','A','CHILL DEPTH','B','CHILL DEPTH','C','CHILL DEPTH','D','CHILL DEPTH','E','CHILL DEPTH');
                                ...
                                $b_cust_spec=array('FRONT END<br>180-230','BRG-1<br>180-230','BRG-2<br>180-230','BRG-3.<br>180-230','BRG-4.<br>180-230','BRG-5<br>180-230','REAR END<br>180-230','CAM BHN AT CENTRE<br>229–302');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="8">BRINELL HARDNESS(5 MM BALL,750 KG LOAD)</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/668_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 1.4 DICR Ex. (Item 0668)" style=" display: none;">
...
<div id="668_page_<?php echo $count; ?>"></div>
<div id="loader_668_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_668_"+<?php echo json_decode($count); ?>).show();
$("#loader_668_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#668_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.668_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#668_page_1_<?php echo json_decode($count); ?>").hide();
$("#668_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_668_<?php echo $count; ?>").one("change", function(){    

   $('#668_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_668_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#668_page_<?php echo $count; ?>').html(data);  
           $("#abcd_668_<?php echo $count;?>").show();
        $("#abcd_668_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_668_<?php echo $count;?>").hide();
//   }
