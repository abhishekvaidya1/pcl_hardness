...
<!--// Page Data--->
<div id="815_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_815_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="815_1_<?php echo $count; ?>">    
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - DC - 611 4 Cyl In.(Item 0815-NEW) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_815_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                        ...
                        <div id="item_img"><img src="Audio/815N_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_815_<?php echo $count; ?>">
                            <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/815_cam.png" style="" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="DC - 611 4 Cyl In.(Item 0815-NEW)" style=" display: none;">
...
<div id="815_page_<?php echo $count; ?>"></div>
<div id="loader_815_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_815_"+<?php echo json_decode($count); ?>).show();
$("#loader_815_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#815_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_815_<?php echo $count; ?>").one("change", function(){    

   $('#815_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#815_page_<?php echo $count; ?>').html(data);  
           $("#abcd_815_<?php echo $count;?>").show();
        $("#abcd_815_<?php echo $count;?>").fadeOut(5000);
