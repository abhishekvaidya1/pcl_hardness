                        ...
                        <table class="table table-bordered table_861_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td style=" width:80px;" colspan="2"><center><input type="text" class="form-control b_action<?php echo $i."_".$count;?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($bitflag==1){?> background-color:red;  color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php
                                $k=9;
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="11">Brinell Hardness<br> At 1.5 mm From<br> Cast Surface<br> After Grinding</td>
                                ...
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center> </td> 
                                </tr>
                                <tr>
