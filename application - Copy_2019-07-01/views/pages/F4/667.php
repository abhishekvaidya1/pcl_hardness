...
<?php  $action = array('45', '5.5', '45', '5.5', '45','5.5','40','5','40','5','40','5','4');
$action2 = array('180', '180', '180', '180','180','180','180','180','229');
$action3 = array('230', '230', '230', '230','230','230','230','230','302');
$pqrs = array('P','Q','R','S','P','Q','R','S','P','Q','R','S');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="667"  style=" display: none;">
...
<!--// Page Data--->
<div id="667_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_667_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="667_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - 1.4 DICR In. (Item 0667) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_667_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="667" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,CHILL DEPTH,A,CHILL DEPTH,B,CHILL DEPTH,C,CHILL DEPTH,D,CHILL DEPTH,E,CHILL DEPTH,OIL SEAL 4 MM  40 HRC" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="2797 0510 79 01" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/159/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/667_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_667_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk((array_slice($b_val, 0, 48)), 6);
                                $b_val_chunk2= array_chunk((array_slice($b_val, 48, 59)), 12);
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','CHILL DEPTH','A','CHILL DEPTH','B','CHILL DEPTH','C','CHILL DEPTH','D','CHILL DEPTH','E','CHILL DEPTH','OIL SEAL 4 MM  40 HRC');
                                $cust_spec=array('5.5 – 45 Min.','O 45 HRc – 5.5 MM Min','5.5 – 45 Min.','A 45 HRc – 5.5 MM Min','5.5 – 45 Min.','B 45 HRc – 5.5 MM Min','5 – 40 Min.','C 40 HRc –5 MM Min','5 – 40 Min.','D 40 HRc –5 MM Min','5 – 40 Min.','E 40 HRc –5 MM Min','');
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">
                                   <?php if($i==12) {?>
                                    <td class="mytdstyle" colspan="2" style="vertical-align: middle;"><?php echo $at_point[$i];?></td>
                                   <?php } else{?><td class="mytdstyle"  style="vertical-align: middle;"><?php echo $at_point[$i];?></td>
                                    <td class="mytdstyle" style="vertical-align: middle;"><?php echo $cust_spec[$i];?></td><?php } ?>
                                <?php $mm=1;for($j=0;$j<count($mm_val_chunk[$i]);$j++)    
                                {   $flag=0;
                                    if ($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i])) { $flag=1; }else{ $flag=0; }?>
                                    <td style=" width:50px;"><input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px; font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo $mm_val_chunk[$i][$j];?>" <?php if($i==12){?>placeholder="<?php echo $pqrs[$j];  ?>"<?php }?>></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 <?php 
                                $b_point=array('BRINELL HARDNESS(5 MM BALL,750 KG LOAD)','','','','','','','','');
                                $b_cust_spec=array('FRONT END<br>180-230','BRG-1<br>180-230','BRG-2<br>180-230','BRG-3.<br>180-230','BRG-4.<br>180-230','BRG-5<br>180-230','BRG-6<br>180-230','REAR END<br>180-230','CAM BHN AT CENTRE<br>229–302');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td colspan="2" style="width:80px;"><center><input type="text" class="form-control b_action<?php echo $i."_".$count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php
                                $k=8;
                                $b_cust_spec2=array('CAM BHN AT CENTRE<br>229–302');
                                ...
                                {   $bitflag=0;
                                    if($b_val_chunk2[$i][$j]!="" && ($b_val_chunk2[$i][$j] < 229 || $b_val_chunk2[$i][$j] > 302)){
                                        $bitflag=1;
                                    }else{
                                        $bitflag=0;
                                    }
                                    ?>
                                   <td style="width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px;font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php $k++;}?>
                                 </tr>
                                 <tr>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" style="vertical-align:middle">5.5 – 45 Min.</td>                             
                                ...
                                <td class="mytdstyle">‘O’ 45 HRc – 5.5 MM Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle">CHILL DEPTH</td>
                                <td class="mytdstyle">‘A’ 45 HRc – 5.5 MM Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">CHILL DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">‘B’ 45 HRc – 5.5 MM Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" style="vertical-align:middle">5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">CHILL DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">‘C’ 40 HRc –5 MM Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">’D’</td>
                                <td class="mytdstyle" style="vertical-align:middle">5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">CHILL DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">‘D’ 40 HRc –5 MM Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">’E’</td>
                                <td class="mytdstyle" style="vertical-align:middle">5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">CHILL DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">‘E’ 40 HRc –5 MM Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle" colspan="2">OIL SEAL 4 MM  40 HRC</td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]"  placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                             </tr>
                             
                                   
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL HARDNESS(5 MM BALL,750 KG LOAD)</td>
                                <td style=" width:80px;" class="mytdstyle">FRONT END<br>180-230</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG-1.<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG-2<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG-3<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG-4<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG-5<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG-6<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">REAR END<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">CAM BHN AT CENTRE<br>229–302</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px; " name="b_val[]" ></center> </td>
                                </tr>    
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/667_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 1.4 DICR In. (Item 0667)" style=" display: none;">
...
<div id="667_page_<?php echo $count; ?>"></div>
<div id="loader_667_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_667_"+<?php echo json_decode($count); ?>).show();
$("#loader_667_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#667_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.667_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#667_page_1_<?php echo json_decode($count); ?>").hide();
$("#667_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(document).on('keyup', '.b_action_<?php echo $count; ?>', function (e) {
    ...
    if(parseInt(th) < 180 || parseInt(th) > 230)
...
$(".page_select_667_<?php echo $count; ?>").one("change", function(){    

   $('#667_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_667_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#667_page_<?php echo $count; ?>').html(data);  
           $("#abcd_667_<?php echo $count;?>").show();
        $("#abcd_667_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_667_<?php echo $count;?>").hide();
//   }
