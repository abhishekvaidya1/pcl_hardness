    ...
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="item_img"><img src="Audio/866_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="95%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                ...
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_866_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('HRB','','','','','','','');
                                $b_cust_spec=array('FRONT END 90 - 103',' BRG.1 90 - 103','BRG.2 90 - 103','BRG.3 90 - 103','BRG.4 90 - 103','BRG.590 - 103','REAR END 90 - 103','COLLAR 90 - 103');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="8">HRB</td>
                                <td style=" width:50px;" class="mytdstyle">FRONT END 90 - 103</td>
                                ...
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle">BRG.1 90 - 103</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.2 90 - 103</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle"> BRG.3 90 - 103 </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.4 90 - 103</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.5 90 - 103</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">REAR END 90 - 103 </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 90 - 103</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/866_cam.png" style="" class=" " width=400""></div></th>
