...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="805"  style=" display: none;">
...
<!--// Page Data--->
<div id="805_page_1_<?php echo $count; ?>">
        <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_805_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="805_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - Ford VEP - 2.0L In. FE (Item 0805) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body">
                    <div id="abcd_805_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="805" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="RFFB5E-6A271-AA" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {
                                                ?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/598/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/805_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_805_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk((array_slice($b_val, 0, 60)), 6);
                                $b_val_chunk2= array_chunk((array_slice($b_val, 60, 83)), 12);
                                ?>
                            <tr>
                               ...
                               <td colspan="4"><div class="input-group"><span class="input-group-addon">L-</span><input type="text" class="form-control l_<?php echo $l."_".$count; ?>"  name="l_val[]" value="<?php echo $L_val[$i];?>" style=" width:90px; font-size: 16px;">
                                ...
                                <?php 
                                $action = array('48', '6.5', '40', '3.5', '40','3.5');
                                ...
                                $cust_spec=array('1.5-48 Min','6.5 Min.','1.5-40 Min','3.5 Min.','1.5-40 Min','3.5 Min.');                           
                                ...
                                $b_cust_spec=array('Front End<br/> 174-255','BRG-1<br> 174-255','BRG-2<br> 174-255','BRG-3<br> 174-255','BRG-4<br> 174-255','BRG-5<br> 174-255','Rear End<br> 174-255','PAD<br> 174-255','Collar 1<br> 174-255','Collar 2<br> 450 MAX.');                                
                                $action2 = array('174','174', '174', '174', '174', '174', '174', '174', '174','0');
                                $action3 = array('255','255', '255', '255', '255', '255', '255', '255', '255','450');
                               ...
                               <?php $bb++;}?> <?php }?>
                                 ...
                                 <?php
                                $k=10;
                                $b_cust_spec2=array('Front End<br> 241 Max','Rear End<br> 241 Max');  
                                $action4 = array('0','0');
                                $action5 = array('241','241');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle">1.5-48 Min</td>                                   
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle">1.5-40 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="10">Brinell Hardness<br> At 1.5 mm From<br> Cast Surface<br> After Grinding</td>
                                <td style=" width:80px;" class="mytdstyle">Front End<br> 174-255</td>
                                ...
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="2">Core Hardness<br> In BHN At 10<br> mm PDC</td>
                                <td class="mytdstyle">Front End<br> 241 Max</td>
                                ...
                                <tr>
                                <td class="mytdstyle">Rear End<br> 241 Max</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/805_cam.png" style="" class=" " width="50%"></div></th>
                        ...
                        <input type="text" name="cust_name" value="Ford VEP - 2.0L In. FE (Item 0805)" style=" display: none;">
...
<div id="805_page_<?php echo $count; ?>"></div>
<div id="loader_805_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_805_"+<?php echo json_decode($count); ?>).show();
$("#loader_805_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#805_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.805_page_2_<?php echo json_decode($count); ?>', function (e) {
$("#805_page_2_<?php echo json_decode($count); ?>").hide();
$("#805_page_1_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_805_<?php echo $count; ?>").one("change", function(){    
   $('#805_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#805_page_<?php echo $count; ?>').html(data);   
      $("#abcd_805_<?php echo $count;?>").show();
        $("#abcd_805_<?php echo $count;?>").fadeOut(5000);
      }
    });       
