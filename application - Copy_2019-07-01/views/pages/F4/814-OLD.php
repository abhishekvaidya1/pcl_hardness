...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="814-OLD"  style=" display: none;">
...
<!--// Page Data--->
<div id="814-OLD_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_814-OLD_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="814-OLD_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - DC - 611 4 Cyl In.(Item 0814-OLD) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_814-OLD_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="814-OLD" readonly="" style=" display: none;">                                
                        ...
                        <!--<div id="item_img"><img src="Audio/814-OLDN_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>-->
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_814-OLD_<?php echo $count; ?>">
                            <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/814-OLD_cam.png" style="" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="DC - 611 4 Cyl In.(Item 0814-OLD)" style=" display: none;">
...
<div id="814-OLD_page_<?php echo $count; ?>"></div>
<div id="loader_814-OLD_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_814-OLD_"+<?php echo json_decode($count); ?>).show();
$("#loader_814-OLD_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#814-OLD_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_814-OLD_<?php echo $count; ?>").one("change", function(){    

   $('#814-OLD_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#814-OLD_page_<?php echo $count; ?>').html(data);  
           $("#abcd_814-OLD_<?php echo $count;?>").show();
        $("#abcd_814-OLD_<?php echo $count;?>").fadeOut(5000);
