...
<?php  $action = array('45', '45', '45', '40', '40','40');
$action2 = array('197', '197', '197', '197','197','197','197','197','229');
$action3 = array('241', '241', '241', '241','241','241','241','241','302');
...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="663"  style=" display: none;">
...
<!--// Page Data--->
<div id="663_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_663_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="663_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - 2.2 DICR In. (Item 0663) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_663_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="663" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,A,B,C,D,OIL SEAL CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="2789 0510 79 01" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/lR/534/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/663_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_663_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','A','B','C','D','OIL SEAL CHILL DEPTH');
                                $cust_spec=array('5.5-45 MIN','5.5-45 MIN','5.5-45 MIN','5.5-40 MIN','5.5-40 MIN','4-40 MIN');
                                ...
                                {   $flag=0;
                                    ...
                                    <td style=" width:50px;"><input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px; font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo $mm_val_chunk[$i][$j];?>" <?php if($i==5){?>placeholder="<?php echo $pqrs[$j] ?>"<?php }?>></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 <?php 
                                $b_point=array('BRINELL HARDNESS AT 0.5 MM FROM CAST SURFACE AFTER GRINDING ON COPE & DRAG.(10 MM BALL DtA & 3000 KG LOAD)','','','','','','','','');
                                $b_cust_spec=array('FRONT END<br>180-230','BRG 1<br>180 - 230','BRG 2<br>180-230','BRG 3<br>180 - 230','BRG 4<br>180 - 230','COLLAR<br>180-230','BRG 5<br>180 - 230','FLANGE<br>180-230','CAM BHN AI CENTER<br>229-302');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td colspan="2" style="width:80px;"><center><input type="text" class="form-control <?php if($i==8){ ?>vng_rng_<?php }else{?>b_action_<?php } echo $count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle">5.5 - 40 MIN.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" style="vertical-align:middle">5.5 - 40 MIN.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">OIL SEAL CHILL DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">4-40 MIN</td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                             </tr>                                   
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL HARDNESS AT 0.5 MM FROM CAST SURFACE AFTER GRINDING ON COPE & DRAG.(10 MM BALL DtA & 3000 KG LOAD)</td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">COLLAR<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">FLANGE<br>180-230</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">CAM BHN AI CENTER<br>229-302</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/663_cam.png" style="" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 2.2 DICR In. (Item 0663)" style=" display: none;">
...
<div id="663_page_<?php echo $count; ?>"></div>
<div id="loader_663_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_663_"+<?php echo json_decode($count); ?>).show();
$("#loader_663_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#663_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.663_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#663_page_1_<?php echo json_decode($count); ?>").hide();
$("#663_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_663_<?php echo $count; ?>").one("change", function(){    

   $('#663_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_663_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#663_page_<?php echo $count; ?>').html(data);  
           $("#abcd_663_<?php echo $count;?>").show();
        $("#abcd_663_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_663_<?php echo $count;?>").hide();
//   }
