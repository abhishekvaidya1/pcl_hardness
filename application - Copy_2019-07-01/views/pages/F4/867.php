        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMI -B12D GEN 1 ln.(Item 0867) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    ...
                    <div id="abcd_867_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        ...
                        <div id="item_img"><img src="Audio/867_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="95%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                ...
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/867_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="GMI -B12D GEN 1 ln.(Item 0867)" style=" display: none;">
