        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="abcd_829_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        ...
                        <div id="item_img"><img src="Audio/829_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>
                    </div>
                </div>
            </div>
        </div>                   
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_829_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                $cust_spec=array('2 – 45 Min.','2 – 45 Min.','2 – 45 Min.','2 – 40Min.','2 – 40Min.','2 – 40Min.','4 mm Min.');
                                ...
                                $b_cust_spec=array('BRG. 1 183 - 300','BRG.2 183 - 300','BRG. 3 183 - 300','BRG. 4 183 - 300','REAR END 183 - 300','Collar 1 183 - 300','Collar 2 183 - 300','Collar 3 183 - 300','Step Dia.183 - 300');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL HARDNESS (5/750 Kg Load)</td>
                                <td style=" width:50px;" class="mytdstyle">BRG. 1 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>

                                
                                </tr>
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle">BRG. 2 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG. 3 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG. 4 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">REAR END 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Collar 1 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Collar 2 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Collar 3 183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Step Dia.183 - 300</td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
