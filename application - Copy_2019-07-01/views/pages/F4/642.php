        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="abcd_642_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        ...
                        <div id="item_img"><img src="Audio/642_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_642_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                $b_cust_spec=array('BRG.1 200–285','BRG.2 200–285','BRG.3 200–285','BRG.4 200–285','BRG.5 200–285','BRG.6 200–285');
                               ...
                               <?php $bb++;}?> <?php }?>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" style="vertical-align:middle">2 - 50 Min</td>                             
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">CHILLING DEPTH</td>
                                <td class="mytdstyle" style="vertical-align:middle">3 mm Min.</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="6">BRINELL HARDNESS(5/750 Kg Load)</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/642_cam.png" style="" class=" "></div></th>
...
$(document).on('click', '.642_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#642_page_1_<?php echo json_decode($count); ?>").hide();
$("#642_page_2_<?php echo json_decode($count); ?>").show();
});
