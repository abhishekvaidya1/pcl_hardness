...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="860"  style=" display: none;">
...
<!--// Page Data--->
<div id="860_page_1_<?php echo $count; ?>">
        <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_860_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="860_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - Ford VEP - 2.3L GTDi Ex.(Maverick)(Item 0860) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body">
                    <div id="abcd_860_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="860" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="RFK2GE-6A272-AA" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {
                                                ?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/645/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/860_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_860_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk((array_slice($b_val, 0, 54)), 6);
                                $b_val_chunk2= array_chunk((array_slice($b_val, 54, 77)), 12);
                                ?>
                            <tr>
                               ...
                               <td colspan="4"><div class="input-group"><span class="input-group-addon">L-</span><input type="text" class="form-control l_<?php echo $l."_".$count; ?>"  name="l_val[]" value="<?php echo $L_val[$i];?>" style=" width:90px; font-size: 16px;">
                                ...
                                $at_point=array('At Point A','Effective chill Depth At Point A','At Point B1','Effective chill Depth At Point B1','At Point B2','Effective chill Depth At Point B2');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('Brinell Hardness At 1.5 mm From Cast Surface After Grinding','','','','','','','','','Core Hardness In BHN At 10 mm PDC');
                                $b_cust_spec=array('BRG-1<br> 174-255','BRG-2<br> 174-255','BRG-3<br> 174-255','BRG-4<br> 174-255','BRG-5<br> 174-255','Rear End<br> 174-255','PAD<br> 174-255','Collar 1<br> 174-255','Collar 2<br> 450 MAX.');                                
                                $action2 = array('174', '174', '174', '174', '174', '174', '174', '174','0');
                                $action3 = array('255', '255', '255', '255', '255', '255', '255', '255','450');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td style="width:80px;" colspan="2"><center><input type="text" class="form-control b_action<?php echo $i."_".$count;?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:80px; font-size: 16px; <?php if($bitflag==1){?> background-color:red;  color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php
                                $k=9;
                                ...
                                <?php $bb=1;for($j=0;$j<count($b_val_chunk2[$i]);$j++)    
                                   ...
                                   <td style=" width:50px;"><center><input type="text" class="form-control b_action<?php echo $k."_".$count;?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black;  <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php $k++;}?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">Brinell Hardness<br> At 1.5 mm From<br> Cast Surface<br> After Grinding</td>
                                <td style=" width:80px;" class="mytdstyle">BRG-1<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td>                           
                                </tr>
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG-2<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-3<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-4<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-5<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Rear End<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">PAD<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Collar 1<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Collar 2<br> 450 MAX.</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                ...
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action9_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                </tr>
                                <tr>
                                <td class="mytdstyle">Rear End<br> 255 Max</td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td style=" width:50px;"><input type="text" class="form-control b_action10_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style=" width:50px;font-size: 16px;" name="b_val[]" > </td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/860_cam.png" style="" class=" " width="50%"></div></th>
                        ...
                        <input type="text" name="cust_name" value="Ford VEP - 2.3L GTDi Ex.(Maverick)(Item 0860)" style=" display: none;">
...
<div id="860_page_<?php echo $count; ?>"></div>
<div id="loader_860_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_860_"+<?php echo json_decode($count); ?>).show();
$("#loader_860_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#860_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.860_page_2_<?php echo json_decode($count); ?>', function (e) {
$("#860_page_2_<?php echo json_decode($count); ?>").hide();
$("#860_page_1_<?php echo json_decode($count); ?>").show();
});

$(document).on('keyup', '.b_action0', function (e) {
    var th=$(this).val();
    var $this = $(this);
...
$(".page_select_860_<?php echo $count; ?>").one("change", function(){    
   $('#860_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#860_page_<?php echo $count; ?>').html(data);   
      $("#abcd_860_<?php echo $count;?>").show();
        $("#abcd_860_<?php echo $count;?>").fadeOut(5000);
      }
    });       
