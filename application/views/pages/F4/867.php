...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="867"  style=" display: none;">
...
<!--// Page Data--->
<div id="867_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_867_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="867_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMI -B12D GEN 1 Ex.(Item 0867) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_867_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="867" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="25199242" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/652/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/867_img.png" style=" display: block;margin-left: auto;margin-right: auto;" ></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_867_<?php echo $count; ?>">
                            <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img"><img src="Audio/867_cam.png" style="" class=" " width="500"></div></th>
                        ...
                        <input type="text" name="cust_name" value="GMI -B12D GEN 1 Ex.(Item 0867)" style=" display: none;">
...
<div id="867_page_<?php echo $count; ?>"></div>
<div id="loader_867_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_867_"+<?php echo json_decode($count); ?>).show();
$("#loader_867_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#867_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.867_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#867_page_1_<?php echo json_decode($count); ?>").hide();
$("#867_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_867_<?php echo $count; ?>").one("change", function(){    

   $('#867_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_867_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#867_page_<?php echo $count; ?>').html(data);  
           $("#abcd_867_<?php echo $count;?>").show();
        $("#abcd_867_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_867_<?php echo $count;?>").hide();
//   }
