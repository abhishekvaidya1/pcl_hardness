...
$action2 = array('183','183','183','183','183','183','183','183','183');
$action3 = array('300','300','300','300','300','300','300','300','300');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="830"  style=" display: none;">
...
<!--// Page Data--->
<div id="830_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_830_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="830_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - SPIL - YL7 - 2CYL ln. (Item 0830) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_830_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>

                        <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="830" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="a,b,c,d,e,f,EFFECTIVE CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="12721 - 83M00" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {
                                                ?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/615/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/830_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_830_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk($b_val, 9);?>
                            <tr>
                                ...
                                <?php 
                                $at_point=array('a','b','c','d','e','f','EFFECTIVE CHILL DEPTH');
                                $cust_spec=array('2 – 45 Min.','2 – 45 Min.','2 – 45 Min.','2 – 40 Min.','2 – 40 Min.','2 – 40 Min.','4 mm Min.');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <tr>
                                     <td></td>
                                     <td></td>
                                     <td colspan="2" class="mytdstyle">AT JOURNAL SURFACE</td>
                                     <td colspan="2" class="mytdstyle">JOURNAL CORE HARDNESS</td>
                                     <td colspan="2" class="mytdstyle">AT JOURNAL SURFACE</td>
                                     <td colspan="2" class="mytdstyle">JOURNAL CORE HARDNESS</td>
                                     <td colspan="2" class="mytdstyle">AT JOURNAL SURFACE</td>
                                     <td colspan="2" class="mytdstyle">JOURNAL CORE HARDNESS</td>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL <br/>HARDNESS <br/>(5/750 Kg Load)<br/><img src="Audio/830_brg.png" width="100" >','','','','','','','','');
                                $b_cust_spec=array('BRG. 1 <br/>183 - 300','BRG. 2 <br/>183 - 300','BRG. 3 <br/>183 - 300','BRG. 4 <br/>183 - 300','REAR END <br/>183 - 300','Collar 1 <br/>183 - 300','Collar 2 <br/>183 - 300','Collar 3 <br/>183 - 300','Step Dia. <br/>183 - 300');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <?php if($j==2 || $j==5 || $j==8) {?>
                                   <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                   <?php } else {?>
                                   <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                   <?php } ?>
                                       <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle">EFFECTIVE CHILL DEPTH</td>
                                <td class="mytdstyle">4 mm Min.</td>
                             ...
                             <tr>
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL <br/>HARDNESS <br/>(5/750 Kg Load)<br/><img src="Audio/830_brg.png" width="100" ></td>
                                <td style=" width:50px;" class="mytdstyle">BRG. 1 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_7_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_8_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_9_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                                         
                                </tr>
                                <tr>                                
                                <td  style=" width:80px;" class="mytdstyle">BRG. 2 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG. 3 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG. 4  <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">REAR END <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">Collar 1 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">Collar 2 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">Collar 3 <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">Step Dia. <br/>183 - 300</td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px; font-size: 16px;" name="b_val[]" ></center></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/830_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="SPIL - YL7 - 2CYL ln. (Item 0830)" style=" display: none;">
...
<div id="830_page_<?php echo $count; ?>"></div>
<div id="loader_830_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
var mm7=$('.mmm_7_<?php echo $count; ?>').hasClass('myClass');
var mm8=$('.mmm_8_<?php echo $count; ?>').hasClass('myClass');
var mm9=$('.mmm_9_<?php echo $count; ?>').hasClass('myClass');
if(m9==true){
...
$("#loader_830_"+<?php echo json_decode($count); ?>).show();
$("#loader_830_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#830_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.830_page_2_<?php echo json_decode($count); ?>', function (e) {
$("#830_page_2_<?php echo json_decode($count); ?>").hide();
$("#830_page_1_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_830_<?php echo $count; ?>").one("change", function(){    
   $('#830_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#830_page_<?php echo $count; ?>').html(data);   
      $("#abcd_830_<?php echo $count;?>").show();
      $("#abcd_830_<?php echo $count;?>").fadeOut(5000);
      }
    });       
