            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - SFT - Rotax 1403 (Item 0742) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    ...
                    <div id="abcd_742_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                        ...
                        <div id="item_img"><img src="Audio/742_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                ...
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_742_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS AT 0.5 MM FROM CAST SURFACE AFTER GRINDING ON COPE & DRAG. (5/750 KG LOAD)<br/><img src="Audio/742_brg.png" width="100">','','','','','','');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="7">BRINELL HARDNESS AT 0.5 MM FROM CAST SURFACE AFTER GRINDING ON COPE & DRAG. (5/750 KG LOAD)<br/><img src="Audio/742_brg.png" width="100"></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/742_cam.png" style="" class=" " ></div></th>
...
$(document).on('click', '.742_page_2_<?php echo json_decode($count); ?>', function (e) {
$("#742_page_2_<?php echo json_decode($count); ?>").hide();
$("#742_page_1_<?php echo json_decode($count); ?>").show();
});
