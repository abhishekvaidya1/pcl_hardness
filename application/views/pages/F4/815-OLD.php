...
<?php  $action = array('48', '48', '48', '45', '45','45','45','40','40','40','6');
...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="815-OLD"  style=" display: none;">
...
<!--// Page Data--->
<div id="815-OLD_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_815-OLD_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="815-OLD_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - DC - 611 4 Cyl In.(Item 0815-OLD) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_815-OLD_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="815-OLD" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="'O' ZONE 1,'A' ZONE 1,'B' ZONE 1,'C' ZONE 2,'D' ZONE 2,'E' ZONE 2,'F' ZONE 2,'G' ZONE 3,'H' ZONE 3,'I' ZONE 3,EFFECTIVE CHILL DEPTH" readonly="" style=" display: none;">
                        ...
                        <!--<div id="item_img"><img src="Audio/815-OLDN_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>-->
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_815-OLD_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array("'O' ZONE 1","'A' ZONE 1","'B' ZONE 1","'C' ZONE 2","'D' ZONE 2","'E' ZONE 2","'F' ZONE 2","'G' ZONE 3","'H' ZONE 3","'I' ZONE 3",'EFFECTIVE CHILL DEPTH');
                                $cust_spec=array('2–48 Min.','2–48 Min.','2–48 Min.','2–45 Min.','2–45 Min.','2–45 Min.','2–45 Min.','2–40 Min.','2–40 Min.','2–40 Min.','6 MM MIN.');
                                ...
                                $b_cust_spec=array('FLANGE<br>180-300',' BRG.3<br>180–300',' BRG.5<br>180–300','CAM CORE 7.5 MM<br>PDC - 300 MAX.');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action<?php if($i==3){?>1<?php } echo $i."_".$count;?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O ZONE 1</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                    <td class="mytdstyle">A ZONE 1</td>
                                    <td class="mytdstyle">2–48 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >B ZONE 1</td>
                                   <td class="mytdstyle" >2–48 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >C ZONE 2</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >D ZONE 2</td>
                                   <td class="mytdstyle" >2–45 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >E ZONE 2</td>
                                   <td class="mytdstyle" >2–45 Min.</td>
                                   ...
                                   <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >F ZONE 2</td>
                                   <td class="mytdstyle" >2–45 Min.</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >G ZONE 3</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >H ZONE 3</td>
                                   <td class="mytdstyle" >2–40 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >I ZONE 3</td>
                                   <td class="mytdstyle" >2–40 Min.</td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">CAM CORE 7.5 MM<br>PDC - 300 MAX.</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/815-OLD_cam.png" style="" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="DC - 611 4 Cyl In.(Item 0815-OLD)" style=" display: none;">
...
<div id="815-OLD_page_<?php echo $count; ?>"></div>
<div id="loader_815-OLD_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_815-OLD_"+<?php echo json_decode($count); ?>).show();
$("#loader_815-OLD_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#815-OLD_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_815-OLD_<?php echo $count; ?>").one("change", function(){    

   $('#815-OLD_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#815-OLD_page_<?php echo $count; ?>').html(data);  
           $("#abcd_815-OLD_<?php echo $count;?>").show();
        $("#abcd_815-OLD_<?php echo $count;?>").fadeOut(5000);
