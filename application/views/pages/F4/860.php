                            ...
                            <tr>
                               ...
                               <td colspan="4"><div class="input-group"><span class="input-group-addon">L-</span><input type="text" class="form-control l_<?php echo $l."_".$count; ?>"  name="l_val[]" value="<?php echo $L_val[$i];?>" style=" width:90px; font-size: 16px;">
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('Brinell Hardness At 1.5 mm From Cast Surface After Grinding<br/><img src="Audio/860_brg.png" width="100" >','','','','','','','','','Core Hardness In BHN At 10 mm PDC');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td style="width:80px;" colspan="2"><center><input type="text" class="form-control b_action<?php echo $i."_".$count;?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:80px; font-size: 16px; <?php if($bitflag==1){?> background-color:red;  color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php
                                $k=9;
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">Brinell Hardness<br> At 1.5 mm From<br> Cast Surface<br> After Grinding<br/><img src="Audio/860_brg.png" width="100" ></td>
                                ...
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-3<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action2_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-4<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">BRG-5<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action4_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Rear End<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action5_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">PAD<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action6_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Collar 1<br> 174-255</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action7_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
                                <td class="mytdstyle">Collar 2<br> 450 MAX.</td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:80px;"  colspan="2"><center><input type="text" class="form-control b_action8_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style=" width:80px;font-size: 16px;" name="b_val[]"></center></td> 
                                </tr>
                                <tr>
