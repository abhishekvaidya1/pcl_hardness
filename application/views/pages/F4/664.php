...
<?php  $action = array('45', '45', '45', '40', '40');
$action2 = array('180', '180', '180', '180','180','180','180','180','180','229');
$action3 = array('230', '230', '230', '230','230','230','230','230','230','302');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="664"  style=" display: none;">
...
<!--// Page Data--->
<div id="664_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_664_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="664_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - 2.2 DICR Ex. (Item 0664) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_664_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="664" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="2789 0510 79 02" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/lR/155/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/664_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="90%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_664_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                $cust_spec=array('5.5-45 MIN','5.5-45 MIN','5.5-45 MIN','5.5-40 MIN','5.5-40 MIN');
                                ...
                                $b_cust_spec=array('FRONT END<br>180-230','BRG 1<br>180 - 230','BRG 2<br>180-230','BRG 3<br>180 - 230','BRG 4<br>180 - 230','COLLAR<br>180-230','BRG 5<br>180 - 230','FLANGE<br>180-230','REAR ENG<br>180-230','CAM BHN AI CENTER<br>229-302');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td colspan="2" style="width:80px;"><center><input type="text" class="form-control <?php if($i==9){?>vng_rng_<?php }else{?>b_action_<?php }echo $count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="10">BRINELL HARDNESS AT 0.5 MM FROM CAST SURFACE AFTER GRINDING ON COPE & DRAG.(10 MM BALL DtA & 3000 KG LOAD)</td>
                                ...
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action0_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>                           
                                </tr>
                                <tr>                                
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/664_cam.png" style="" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 2.2 DICR Ex. (Item 0664)" style=" display: none;">
...
<div id="664_page_<?php echo $count; ?>"></div>
<div id="loader_664_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_664_"+<?php echo json_decode($count); ?>).show();
$("#loader_664_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#664_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.664_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#664_page_1_<?php echo json_decode($count); ?>").hide();
$("#664_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(document).on('keyup', '.b_action_<?php echo $count; ?>', function (e) {
    ...
    if(parseExt(th) < 180 || parseExt(th) > 230)
...
$(document).on('keyup', '.vng_rng_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseExt(th) < 229 || parseExt(th) > 302)
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(".page_select_664_<?php echo $count; ?>").one("change", function(){    

   $('#664_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_664_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#664_page_<?php echo $count; ?>').html(data);  
           $("#abcd_664_<?php echo $count;?>").show();
        $("#abcd_664_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_664_<?php echo $count;?>").hide();
//   }
