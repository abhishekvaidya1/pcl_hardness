...
$action2 = array('180', '180', '180', '180','180', '180', '180', '180');
$action3 = array('230', '230', '230', '230','230', '230', '230', '230');
    ...
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="item_img"><img src="Audio/667_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="85%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                        ...
                        <table class="table table-bordered table_667_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                {?><tr style="vertical-align: center; text-align: center">                                      
                                    <td class="mytdstyle" style="vertical-align: middle;" <?php if($i==12){?> colspan="2" <?php } ?>><?php echo $at_point[$i];?></td>                                   
                                    <?php if($i!=12){ ?>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL <br/>HARDNESS<br/> (5 MM BALL, 750 KG LOAD)<br/><img src="Audio/667_brg.png" width="100">','','','','','','','','');
                                $b_cust_spec=array('FRONT END <br/>180 - 230','BRG- 1. <br/>180 - 230','BRG- 2. <br/>180 - 230','BRG- 3.<br/>180 - 230','BRG-4. <br/>180 - 230','BRG-5. <br/>180 - 230','BRG- 6. <br/>180 - 230','REAR END <br/>180 - 230');
                               ...
                               {?><tr style="vertical-align: center; text-align: center">                                    
                            <td class="mytdstyle">CAM BHN AT CENTRE <br/>229 – 302</td>   
                               ...
                               <?php $bb++;}?> <?php } ?>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘B’ 45 HRc – 5.5 MM Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >5 – 40 Min.</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘C’ 40 HRc – 5 MM Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘D’ 40 HRc – 5 MM Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘E’ 40 HRc – 5 MM Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                    <td class="mytdstyle" colspan="2">OIL SEAL 4 MM  40 HRC</td>
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL <br>HARDNESS<br/> (5 MM BALL, <br>750 KG LOAD)<br/><img src="Audio/667_brg.png" width="100"></td>
