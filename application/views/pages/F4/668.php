...
$action2 = array('180', '180', '180', '180','180', '180', '180');
$action3 = array('230', '230', '230', '230','230', '230', '230');?>
<!-- Page Data--->
    ...
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="item_img"><img src="Audio/668_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="85%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                        ...
                        <table class="table table-bordered table_668_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL<br/> HARDNESS<br/> (5 MM BALL, 750 KG LOAD)<br/><img src="Audio/668_brg.png" width="100">','','','','','','','');
                                $b_cust_spec=array('FRONT END <br/>180 - 230','BRG- 1. <br/>180 - 230','BRG- 2. <br/>180 - 230','BRG- 3.<br/>180 - 230','BRG-4. <br/>180 - 230','BRG-5. <br/>180 - 230','REAR END <br/>180 - 230');
                            ...
                            <td class="mytdstyle">CAM BHN AT CENTRE <br/>229 – 302</td>   
                               ...
                               <?php $bb++;}?> <?php } ?>
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="8">BRINELL <br>HARDNESS<br/> (5 MM BALL, <br>750 KG LOAD)<br/><img src="Audio/668_brg.png" width="100"></td>
