...
<?php  $action = array('48', '40', '40', '40', '5');
$action2 = array('200', '200', '200');
$action3 = array('285', '285', '285');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="670"  style=" display: none;">
...
<!--// Page Data--->
<div id="670_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_670_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="670_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMA - Fam 0 - 4cyl - Gen3 (Item 0670) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_670_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="670" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="ZONE 1 O,ZONE 1 A At 85 º,ZONE 1 B At 85 º,ZONE 2 C,EFFECTIVE CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/162/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/670_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>
                    </div>
                </div>
            </div>
        </div>                   
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_670_<?php echo $count; ?>">
                            ...
                            <?php
                                ...
                                $b_val_chunk2= array_chunk((array_slice($b_val, 18, 30)), 12);
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('ZONE 1<br/>O','ZONE 1<br/>A At 85 º','ZONE 1<br/>B At 85 º','ZONE 2<br/>C','EFFECTIVE<br/>CHILL DEPTH');
                                $cust_spec=array('05 – 48 Min.','3.5 – 40 Min.','3.5 – 40 Min.','3.5 – 40 Min.','5 mm Min.<br/>All Over');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL<br>HARDNESS<br>(5/750 Kg Load) ','','','');
                                $b_cust_spec=array('BRG 1 <br/>200 - 285','BRG 3 <br/>200 - 285','BRG 5 <br/>200 - 285');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td  style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                ...
                                $action4 = array('200');
                                $action5 = array('285');
                                 $b_cust_spec2=array('CAM CORE <br/>7 MM PDC <br/>200 – 285<br/>BHN');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle">ZONE 1 <br/>'O'</td>
                                   <td class="mytdstyle">05 – 48 Min.</td>                                   
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle">ZONE 1 <br/>'A'  At 85 º</td>
                                <td class="mytdstyle">3.5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle">ZONE 1 <br/>'B'  At 85 º</td>
                                <td class="mytdstyle">3.5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle"> ZONE 2 <br/>'C'</td>
                                <td class="mytdstyle">3.5 – 40 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle">EFFECTIVE CHILL <br/>DEPTH </td>
                                <td class="mytdstyle">5  mm Min.<br/> All Over</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">BRINELL<br/>HARDNESS<br/>( 5/750 Kg Load )</td>
                                <td style=" width:60px;" class="mytdstyle">BRG 1 <br/>200 - 285</td>
                                ...
                                <tr>                                
                                <td style=" width:60px;" class="mytdstyle">BRG 3 <br/>200 - 285</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">BRG 5 <br/>200 - 285</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px; font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>
                                 <td style=" width:60px;" class="mytdstyle"> CAM CORE <br/>7 MM PDC <br/>200 – 285 BHN</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><img src="Audio/670_cam.png" style="" class=" "></th>
                        ...
                        <input type="text" name="cust_name" value="GMA - Fam 0 - 4cyl - Gen3 (Item 0670)" style=" display: none;">
...
<div id="670_page_<?php echo $count; ?>"></div>
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#670_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.670_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#670_page_1_<?php echo json_decode($count); ?>").hide();
$("#670_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_670_<?php echo $count; ?>").one("change", function(){    

   $('#670_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_670_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#670_page_<?php echo $count; ?>').html(data);  
           $("#abcd_670_<?php echo $count;?>").show();
        $("#abcd_670_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_670_<?php echo $count;?>").hide();
//   }
