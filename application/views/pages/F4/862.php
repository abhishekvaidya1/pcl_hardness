...
$action2 = array('90', '90', '90', '90','90','90','90','0','90','0','90');
$action3 = array('107','107','107','107','107','107','107','107','107','110','107');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="862"  style=" display: none;">
...
<!--// Page Data--->
<div id="862_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_862_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="862_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - MSIL - E15 In.(Item 0862)- <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_862_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="862" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="12711 - 56 RAO" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/647/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/862_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_862_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk((array_slice($b_val, 0, 132)), 12);
                                $b_val_chunk2= array_chunk((array_slice($b_val, 132, 137)), 3);
                               ?>
                            <tr>
                                ...
                                <?php 
                                $at_point=array('a','b','c','g','h','d','e','f','Portion ‘E’’Hardness<br>112 HRB Max','Portion ‘E’’Hardness 112 HRB Max','Portion ‘E’’Hardness 112 HRB Max','Portion ‘E’’Hardness 112 HRB Max');
                                $cust_spec=array('4-48 Min.','4-45 Min.','4-45 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.','4-42 Min.');
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">   
                                     <?php if($i<=8){ ?>
                                    <td class="mytdstyle" <?php if($i==8){ ?> colspan="2" rowspan="4" <?php } ?> style="vertical-align: middle;"><?php echo $at_point[$i];?></td>                                   
                                     <?php } if($i<8){ ?>
                                   <td class="mytdstyle" style="vertical-align: middle;"><?php echo $cust_spec[$i]; ?></td>                                   
                                    <?php } ?>
                                <?php $mm=1;for($j=0;$j<count($mm_val_chunk[$i]);$j++)    
                                {   $flag=0; 
                                    if($i>=8 && ($mm_val_chunk[$i][$j]!="" && $mm_val_chunk[$i][$j] > 112)) 
                                        { $flag=1; }
                                    else if($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i])) 
                                        { $flag=1; }
                                    else{ $flag=0; }?>
                                   <td style=" width:50px;">
                                   <input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px;font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo( $mm_val_chunk[$i][$j]);?>"></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 <?php 
                                $b_point=array('ROCKWELL HARDNESS - B Scale ( HRB)At 2 mm from Cast Surface.( 98.5 ± 8.5 HRB )','','','','','','','','','','');
                                $b_cust_spec=array('FRONT END <br/>90 - 107','BRG 1 <br/>90 - 107','BRG 2 <br/>90 - 107','BRG 3 <br/>90 - 107','BRG 4 <br/>90 - 107','BRG 5 <br/>90 - 107','REAR END<br/>90 - 107','Adjacent dimeter<br/>107 max','Data Matrix<br/>90 - 107','Collar 1 <br/>110 max','Collar 2  <br/>90 - 107');
                               ...
                               <?php $bb++;}?> <?php } ?>
                                   ...
                                   <?php 
                               $col_name=array("Collar 1<br>1.5 MM Max","Collar 2<br>1.5 MM Max");
                             ...
                             <tr style="vertical-align: center; text-align: center">                                
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="11">ROCKWELL<br> HARDNESS - <br>B Scale ( HRB)<br>At 2 mm from<br> Cast Surface.<br> ( 98.5 ± 8.5 HRB ) </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Collar 2<br/>90 - 107</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle" >Collar 2<br>1.5 MM Max</td>
                                <td  colspan="4" style=" width:80px;"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="4" style=" width:80px;"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td  colspan="4" style=" width:80px;"><center><input type="text" class="form-control b_action3_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                </tr>      
                                <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img"><img src="Audio/862_cam.png" style="" class=" " width="450"></div></th>
                        ...
                        <input type="text" name="cust_name" value="MSIL - E15 In.(Item 0862)" style=" display: none;">
...
<div id="862_page_<?php echo $count; ?>"></div>
<div id="loader_862_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_862_"+<?php echo json_decode($count); ?>).show();
$("#loader_862_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#862_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.862_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#862_page_1_<?php echo json_decode($count); ?>").hide();
$("#862_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_862_<?php echo $count; ?>").one("change", function(){    

   $('#862_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_862_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#862_page_<?php echo $count; ?>').html(data);  
           $("#abcd_862_<?php echo $count;?>").show();
        $("#abcd_862_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_862_<?php echo $count;?>").hide();
//   }
