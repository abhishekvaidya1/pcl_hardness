...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="694"  style=" display: none;">
...
<!--// Page Data--->
<div id="694_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_694_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="694_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMK - BDOHC - Gen 2 B15D (Item 0694) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_694_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="694" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="25189707" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/184/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/694_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="80%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_694_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                {?><tr style="vertical-align: center; text-align: center">  
                                    ...
                                    <td class="mytdstyle" style="vertical-align: middle; text-align: middle"><?php echo $at_point[$i];?></td>                                   
                                    <td class="mytdstyle" style="vertical-align: middle; text-align: middle"><?php echo $cust_spec[$i];?></td> 
                                    <td class="mytdstyle" style="vertical-align: middle; text-align: middle"><?php echo $work_spec[$i];?></td> 
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" style="vertical-align: middle; text-align: middle">O</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">2 - 48 - 56</td>                             
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">3 - 48 - 56</td> 
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">B</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">2 - 48 - 56</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">3 - 48 - 56</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">C</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">2 - 40 Min</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">3 - 40 Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">D</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">2 - 40 Min</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: middle">3 - 40 Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: center">4 - 12 mm <br/>From Cam <br/>Peak</td>
                                   <td class="mytdstyle" style="vertical-align: middle; text-align: center">4 - 12 mm AT <br/>± 25° From <br/>Cam Peak</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th style="border:#ffffff;"></th>
                                <th style="border-left:#ffffff;"><div id="item_img" ><img src="Audio/694_cam.png" class=" "></div></th>
                        ...
                        <input type="text" name="cust_name" value="GMK - BDOHC - Gen 2 B15D (Item 0694)" style=" display: none;">
...
<div id="694_page_<?php echo $count; ?>"></div>
<div id="loader_694_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_694_"+<?php echo json_decode($count); ?>).show();
$("#loader_694_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#694_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_694_<?php echo $count; ?>").one("change", function(){    

   $('#694_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#694_page_<?php echo $count; ?>').html(data);  
           $("#abcd_694_<?php echo $count;?>").show();
        $("#abcd_694_<?php echo $count;?>").fadeOut(5000);
