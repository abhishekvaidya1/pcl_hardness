...
<?php  $action = array('45', '45', '45', '25', '25','90');
$action2 = array('90', '90', '90','90', '90', '90','90', '90', '90');
$action3 = array('107', '107', '107','107', '107', '107','107', '107', '107');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="763"  style=" display: none;">
...
<!--// Page Data--->
<div id="763_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_763_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="763_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - MSIL - K10 In. (Item 0763) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_763_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="763" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="a,b,c,d,e, Base Circle Hardness HRB" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="12711-51K00" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/556/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/763_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="80%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_763_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('a','b','c','d','e','Base Circle<br/>Hardness HRB');
                                $cust_spec=array('2 - 45 Min.','2 - 45 Min.','2 - 45 Min.','2 - 25Min.','2 - 25Min.','90-107');
                                $work_spec=array('3 - 45 Min.','3 - 45 Min.','3 - 45 Min.','3 - 25 Min.','3 - 25 Min.','90-105');
                                ...
                                {   $flag=0;
                                    if($i==5 && ($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i] || $mm_val_chunk[$i][$j] > 107))) {
                                        $flag=1;                                         
                                    }else if($mm_val_chunk[$i][$j]!="" && $mm_val_chunk[$i][$j] < $action[$i]){ 
                                        $flag=1;                                         
                                    }else{ 
                                        $flag=0;                                         
                                    }?>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('ROCKWELL<br/>HARDNESS <br/>B Scale <br/>(HRB) At 2 mm <br/>from Cast <br/>Surface.','','','','','','','','');
                                $b_cust_spec=array('Front End <br/>90 - 107','BRG. 1 <br/>90 - 107','BRG. 2 <br/>90 - 107','BRG. 3 <br/>90 - 107','BRG. 4 <br/>90 - 107','BRG. 5 <br/>90 - 107','REAR END <br/>90 - 107','Collar 1 <br/>90 - 107','Collar 2 <br/>90 - 107');
                                $b_work_spec=array('Front End <br/>90 - 100','BRG. 1 <br/>90 - 100','BRG. 2 <br/>90 - 100','BRG. 3 <br/>90 - 100','BRG. 4 <br/>90 - 100','BRG. 5 <br/>90 - 100','REAR END <br/>90 - 100','Collar 1 <br/>90 - 100','Collar 2 <br/>90 - 100');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >2 - 25Min.</td>
                                   <td class="mytdstyle" >3 - 25 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >Base Circle <br/>Hardness HRB</td>
                                   <td class="mytdstyle" >90-107</td>
                                   <td class="mytdstyle" >90-105</td>
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="9">ROCKWELL<br/>HARDNESS <br/>B Scale <br/>(HRB) At 2 mm <br/>from Cast <br/>Surface.</td>
                                <td  style=" width:80px;" class="mytdstyle">Front End<br/>90 - 107</td>
                                <td  style=" width:80px;" class="mytdstyle">Front End<br/>90 - 100</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG. 1<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG. 2<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG. 3<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG. 4<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">BRG. 5<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">REAR END<br/>90 - 107</td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">Collar 1<br/>90 - 107</td>
                                <td style=" width:80px;" class="mytdstyle">Collar 1<br/>90 - 100</td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                ...
                                <tr>                                
                                <td style=" width:80px;" class="mytdstyle">Collar 2<br/>90 - 107</td>
                                <td style=" width:80px;" class="mytdstyle">Collar 2<br/>90 - 100</td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th style="border:#ffffff;"></th>
                                <th style="border-left:#ffffff;"><div id="item_img" ><img src="Audio/763_cam.png" class=" " width="450"></div></th>
                        ...
                        <input type="text" name="cust_name" value="MSIL - K10 In. (Item 0763)" style=" display: none;">
...
<div id="763_page_<?php echo $count; ?>"></div>
<div id="loader_763_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_763_"+<?php echo json_decode($count); ?>).show();
$("#loader_763_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#763_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_763_<?php echo $count; ?>").one("change", function(){    

   $('#763_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#763_page_<?php echo $count; ?>').html(data);  
           $("#abcd_763_<?php echo $count;?>").show();
        $("#abcd_763_<?php echo $count;?>").fadeOut(5000);
