...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="857"  style=" display: none;">
...
<!--// Page Data--->
<div id="857_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_857_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="857_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - SIMPSON - Simpson 3 Cyl. (Item 0857)<?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_857_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="857" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="PF-A3-209" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/642/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/857_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_857_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $b_point=array('BRINELL HARDNESS BHN(10 MM BALL ,3000 KG LOAD)OR(5 MM BALL , 750 KG LOAD)<br/><img src="Audio/857_brg.png" width="100">','','','','');
                                $b_cust_spec=array('FLANGE<br/>229 - 285','BRG 1<br/>229 - 285','BRG 2<br/>229 - 285','BRG 3<br/>229 - 285');
                                ...
                                {   $bitflag=0;
                                    if($b_val_chunk[$i][$j]!="" && ($b_val_chunk[$i][$j] < $action2[$i] || $b_val_chunk[$i][$j] > $action3[$i])){
                                     ...
                                     ?>
                                        <td <?php if($j%3==2){ ?> colspan="2" <?php } ?> style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">BRINELL HARDNESS BHN(10 MM BALL ,3000 KG LOAD)OR (5 MM BALL , 750 KG LOAD)<br/><img src="Audio/857_brg.png" width="100"></td>
                                <td style=" width:50px;" class="mytdstyle">FLANGE <br>229 - 285</td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/857_cam.png" style="" class=" " width="200"></div></th>
                        ...
                        <input type="text" name="cust_name" value="SIMPSON - Simpson 3 Cyl. (Item 0857)" style=" display: none;">
...
<div id="857_page_<?php echo $count; ?>"></div>
<div id="loader_857_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_857_"+<?php echo json_decode($count); ?>).show();
$("#loader_857_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#857_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_857_<?php echo $count; ?>").one("change", function(){    

   $('#857_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#857_page_<?php echo $count; ?>').html(data);  
           $("#abcd_857_<?php echo $count;?>").show();
        $("#abcd_857_<?php echo $count;?>").fadeOut(5000);
