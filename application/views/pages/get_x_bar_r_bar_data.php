...
//    print_r($final_split_by_para);
    $colspan_count=$hr_data1= array_chunk($final_split_by_para, 4);
    $colspan_count=count($colspan_count)-2;
    
    ?>
<div class="btn-group pull-right">
    <form class="form-horizontal"  method="post" name="myForm1" id="myForm1" enctype="multipart/form-data" action="<?php echo base_url();?>download_report_x_bar_r_bar/<?php echo $item;?>/<?php echo $s_date;?>/<?php echo $e_date;?>/<?php echo base64_encode($atpoint1);?>">    
...
<br><br>
    <div id="printDiv" style="width: 100%; overflow-x: scroll;">
        ...
        <table border="1" align="center" class="customers2">
            <tr>
                ...
                <td rowspan="2" style=" vertical-align:  middle;" align="center"><b>QUALITY ASSURANCE</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="center" style=" vertical-align:  middle;" align="center" colspan="<?php echo $colspan_count+1;?>"><b>OPERATION : DATE CONTROL LIMITS CALCULATED :</b></td>
                <td align="center" style=" vertical-align:  middle;" align="center" ><b>ENG.SPEC : 45 - 55 HRc</b></td>
                
                
            </tr>
            <tr>
                <td align="center" style=" vertical-align:  middle;" align="center"><b>ITEM NO. - 0670 C/S</b></td>
                <td align="center" style=" vertical-align:  middle;" align="center"><b>CHARACTERISTIC :<?php echo $atpoint[1];?></b></td>
                <td align="center" style=" vertical-align:  middle;" align="center" colspan="<?php echo $colspan_count+1;?>"><b>SAMPLE SIZE /FREQ. 03/Heat</b></td>
                <td align="center"  style=" vertical-align:  middle;" align="center"><b>PART NAME : 55562231</b></td>
            ...
            ?>
            <tr>
                <td style=" vertical-align:  middle;" align="center"><b>AVERAGE X =  <?php echo round(@$avr_x_bar1); ?>   </b></td>
                <td align="center" style=" vertical-align:  middle;" align="center"><b>UCL= X+A2*R = <?php echo round(@$avg_ucl1); ?></b></td>
                <td align="center" style=" vertical-align:  middle;" align="center"><b>LCL = X-A2*R = <?php echo round(@$avg_lcl1); ?></b></td>
                <td align="center" colspan="<?php echo $colspan_count+1;?>" style=" vertical-align:  middle;" align="center"><b>LCL = X-A2*R =AVERAGES (X BAR CHART )</b></td>

            </tr>
            <tr>
                <td colspan="<?php echo $colspan_count+4;?>"><div id="container" style=" width: 1100px;"></div>  </td>
            </tr>
            <tr>
                <td colspan="<?php echo $colspan_count+4;?>"><div id="container1" style=" width: 1100px;"></div>  </td>
            </tr>
        </table>
        <br>
        <table border="1" align="center" class="customers2">
    ...
    for ($j = 0; $j < 4; $j++) {
        ...
        for ($i = 0; $i < count($hr_data_chunk); $i++) {
            ...
            <tr>
                <td style=" vertical-align:  middle;" align="center">∑X</td>
            ...
            <tr>
                <td style=" vertical-align:  middle;" align="center">x̅</td>
    ...
    for ($s = 0; $s < count($hr_data_chunk); $s++) {
        ...
        <table border="1" align="center" class="customers2">
            <tr>
                    ...
                    <td style=" vertical-align:  middle;" align="center">CONTROL LIMITS FOR AVERAGE CHART-UCL </td>
                    <td style=" vertical-align:  middle;" align="center" colspan="<?php echo $colspan_count+1;?>">CONTROL LIMITS FOR AVERAGE CHART-LCL</td>
            ...
            <tr>
                    ...
                    <td style=" vertical-align:  middle;" align="center">CONTROL LIMITS FOR RANGES-UCL</td>
                    <td style=" vertical-align:  middle;" align="center">CONTROL LIMITS FOR RANGES-LCL</td>
