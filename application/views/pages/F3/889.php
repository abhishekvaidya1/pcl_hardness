...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="889"  style=" display: none;">
...
<!--// Page Data--->
<div id="889_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_889_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="889_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth - TML - 486 PLi Ex. (Item 0889)<?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_889_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="889" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="279905107902" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/675 /101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/889_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_889_<?php echo $count; ?>">
                            <tr>
                                <td rowspan="3" style=" vertical-align:  middle; text-align: center;" width="15%">AT POINT</td>
                                <td rowspan="2" style=" vertical-align:  middle; text-align: center;" width="30%">CUSTOMER SPEC.</td>                                
                            ...
                            <tr>
                                ...
                                $cust_spec=array('6 - 15 - 45 MIN','3 – 45 MIN','3 – 45 MIN','3 – 45 MIN');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN (10 MM BALL , 3000 KG LOAD)<br/><img src="Audio/889_brg.png" width="100">');
                                ...
                                {?><tr style="vertical-align: center; text-align: center">
                                    ...
                                    <td class="mytdstyle" style=" vertical-align: middle;">CAM BHN AT CENTRE 229-302</td>                                   
                                ...
                                {   $bitflag=0;
                                    ...
                                    <?php }
                                    ?>
                                        <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                                 
                                 <?php                                 
                                $b_cust_spec=array('BRG 1<br/>180-230','BRG 3<br/>180-230','BRG 5<br/>180-230');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                        <td colspan="2" style=" width:80px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:80px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >o</td>
                                   <td class="mytdstyle" >6 - 15 - 45 MIN</td>                             
                                ...
                                <td class="mytdstyle">3 – 45 MIN</td>
                            ...
                            <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">BRINELL HARDNESS <br>BHN (10 MM BALL , 3000 KG LOAD)<br/><img src="Audio/889_brg.png" width="100"></td>
                                <td style=" width:50px;" class="mytdstyle">CAM BHN AT CENTRE<br/>229 - 302</td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>    
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action1<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>    
                            </tr>
                            <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG 1<br/>180-230</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>    
                            </tr>
                            <tr>                                
                                <td style=" width:50px;" class="mytdstyle"> BRG 3<br/>180-230</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                            ...
                            <tr>                                
                                <td style=" width:50px;" class="mytdstyle"> BRG 5<br/>180-230</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/889_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 486 PLi Ex. (Item 0889)" style=" display: none;">
...
<div id="889_page_<?php echo $count; ?>"></div>
<div id="loader_889_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_889_"+<?php echo json_decode($count); ?>).show();
$("#loader_889_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#889_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_889_<?php echo $count; ?>").one("change", function(){    

   $('#889_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#889_page_<?php echo $count; ?>').html(data);  
           $("#abcd_889_<?php echo $count;?>").show();
        $("#abcd_889_<?php echo $count;?>").fadeOut(5000);
