...
$action2 = array('0','229', '229', '229', '229');
$action3 = array('40','302', '302', '302', '302');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="910"  style=" display: none;">
...
<!--// Page Data--->
<div id="910_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_910_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="910_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - ESCORT - E3-276 (Item 0910)<?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_910_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="910" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,A,B,C,D" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="D10493510" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/695/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/910_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_910_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','A','B','C','D');
                                $cust_spec=array('5 MM – 45 HRc MIN','5 MM – 45 HRc MIN','5 MM – 45 HRc MIN','3 – 350 Hv MIN 30 Kg','3 – 350 Hv MIN 30 Kg');
                                ...
                                $b_point=array("HARDNESS AT FILLET RADIUS B-B' & C-C (NO CLEAR CHILLING IS PERMITTED)",'BRINELL HARDNESS BHN (10 MM BALL 3000 KG LOAD)<br/><img src="Audio/910_brg.png" width="100">','','','');
                                $b_cust_spec=array('40 HRc Max','BRG 1<br/>229-302','BRG 2<br/>229-302','BRG 3<br/>229-302','BRG 4<br/>229-302');
                                for($i=0;$i<count($b_val_chunk);$i++)
                                {?><tr style="vertical-align: middle; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;"><?php echo $b_point[$i];?></td><?php }else if($i==1){ ?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" rowspan="4"><?php echo $b_point[$i];?></td><?php }?>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O</td>
                                   <td class="mytdstyle" >5 MM – 45 HRc MIN</td>                             
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" >3 – 350 Hv MIN 30 Kg</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" style=" vertical-align: middle; text-align: center;">HARDNESS AT FILLET RADIUS B-B' & C-C ( NO CLEAR CHILLING IS PERMITTED )</td>
                                <td class="mytdstyle" style=" vertical-align: middle; text-align: center;">40 HRc Max</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">BRINELL HARDNESS <br>BHN (10 MM BALL 3000 KG LOAD)<br/><img src="Audio/910_brg.png" width="100"></td>
                                <td style=" width:50px;" class="mytdstyle">BRG 1<br/>229-302</td>
                                ...
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle"> BRG 2<br/>229-302</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle"> BRG 3<br/>229- 302</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG 4<br/>229-302</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/910_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="ESCORT - E3-276 (Item 0910)" style=" display: none;">
...
<div id="910_page_<?php echo $count; ?>"></div>
<div id="loader_910_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_910_"+<?php echo json_decode($count); ?>).show();
$("#loader_910_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#910_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_910_<?php echo $count; ?>").one("change", function(){    

   $('#910_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#910_page_<?php echo $count; ?>').html(data);  
           $("#abcd_910_<?php echo $count;?>").show();
        $("#abcd_910_<?php echo $count;?>").fadeOut(5000);
