...
<?php  $action = array('45', '45', '45', '40', '40', '40','4');
$action2 = array('180', '180', '180');
$action3 = array('230', '230', '230');
...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="671"  style=" display: none;">
...
<!--// Page Data--->
<div id="671_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_671_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="671_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - ACE CNG (Item 0671) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_671_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="671" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="CAM O,At 30<sup>o</sup> A,At 30<sup>o</sup> E,At 90<sup>o</sup> B,At 90<sup>o</sup> D,B.C.D C,OIL SEAL HARDNESS" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="5708 0510 7902" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) { ?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/163/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/671_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="60%" height="180"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_671_<?php echo $count; ?>">
                            <tr>
                                <td rowspan="3" colspan="2" style=" vertical-align:  middle; text-align: center;width: 60px;">AT POINT</td>
                            ...
                            <?php
                                ...
                                $b_val_chunk2= array_chunk((array_slice($b_val, 0, 12)), 12);
                                $b_val_chunk= array_chunk((array_slice($b_val, 12, 29)), 6);?>
                            <tr>
                                ...
                                <?php 
                                $at_point=array('CAM','At 30<sup>o</sup>','At 30<sup>o</sup>','At 90<sup>o</sup>','At 90<sup>o</sup>','B.C.D','OIL SEAL HARDNESS');
                                $at_point1=array('O','A','E','B','D','C','4.0 MM MIN AT 40 HRc');
                                $cust_spec=array('6.5 - 45 Min','5.0 - 45 Min','5.0 - 45 Min','5.0 - 40 Min','5.0 - 40 Min','5.0 - 40 Min','');
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">  
                                    <?php if($i!=2 && $i!=4){ ?>
                                    <td class="mytdstyle" style="vertical-align: middle; width: 60px;" <?php if($i==1 || $i==3){ ?> rowspan="2" <?php } ?>><?php echo $at_point[$i];?></td>                                   
                                    <?php } ?>
                                    <td class="mytdstyle" style="vertical-align: middle; width: 60px;" <?php if($i==6){ ?> colspan="2" <?php } ?> >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $at_point1[$i];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                                    <?php if($i!=6){ ?><td class="mytdstyle" style="vertical-align: middle; width: 60px;"><?php echo $cust_spec[$i];?></td> <?php } ?>
                                        
                                <?php $mm=1;for($j=0;$j<count($mm_val_chunk[$i]);$j++)    
                                {   $flag=0;
                                    if($mm_val_chunk[$i][$j]!="" && $mm_val_chunk[$i][$j] < $action[$i]) { $flag=1; }else{ $flag=0; }?>
                                    <td style=" width:50px;"><input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px;font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo $mm_val_chunk[$i][$j];?>" <?php if($i==6){ ?> placeholder="<?php echo $pqrs[$j]; ?>" <?php } ?> ></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 
                                 
                                 <?php 
                                $b_point=array('BRINELL HARDNESS (10 MM BALL, 3000 KG LOAD)<br/><img src="Audio/671_brg.png" width="100">','','','');
                                $b_cust_spec=array('CAM BHN AT CENTRE-<br/>229 - 302 BHN');
                                ...
                                {?><tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" colspan="2"><?php echo $b_cust_spec[$i];?></td>                                   
                                ...
                                {   $bitflag=0;
                                    if($b_val_chunk2[$i][$j]!="" && ($b_val_chunk2[$i][$j] < 229 || $b_val_chunk2[$i][$j] > 302)){
                                     ...
                                     ?>
                                        <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                                                                  
                                 <?php 
                                  $b_cust_spec=array('BRG-1 <br/> 180 - 230','BRG-2 <br/> 180 - 230','BRG-3 <br/> 180 - 230');
                                ...
                                <tr>
                                   ...
                                   <tr style="vertical-align: center; text-align: center">
                                       <td class="mytdstyle" style="vertical-align:middle; text-align: center;" >CAM</td>
                                   <td class="mytdstyle" style="vertical-align:middle; text-align: center; width: 60px;">O</td>
                                   <td class="mytdstyle" style="vertical-align:middle; text-align: center;">6.5 - 45 Min</td>                        
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" rowspan="2" style="vertical-align:middle; text-align: center;">At 30<sup>o</sup></td>
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">A</td>
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">5.0 - 45 Min</td>
                            ...
                            <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" rowspan="2" style="vertical-align:middle; text-align: center;">At 90<sup>o</sup></td>
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">B</td>
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">5.0 - 40 Min</td>
                            ...
                            <tr style="vertical-align: center; text-align: center">                                
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">B.C.D</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle; text-align: center;">OIL SEAL  HARDNESS</td>
                                <td class="mytdstyle" colspan="2" style="vertical-align:middle; text-align: center;">4.0 MM MIN AT 40 HRc</td>                                
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                <td style=" width:50px;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>                                
                             </tr>
                                                         
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">BRINELL HARDNESS (10 MM BALL, 3000 KG LOAD)<br/><img src="Audio/671_brg.png" width="100"></td>
                                <td style=" width:50px;" class="mytdstyle" colspan="2">CAM BHN AT CENTRE<br>229 - 302 BHN</td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>                                
                                </tr>
                                
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle" colspan="2">BRG-1<br>180 - 230</td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle" colspan="2">BRG-2 <br/>180 - 230</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle" colspan="2">BRG-3 <br/>180 - 230</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/671_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - ACE CNG (Item 0671)" style=" display: none;">
...
<div id="671_page_<?php echo $count; ?>"></div>
<div id="loader_671_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_671_"+<?php echo json_decode($count); ?>).show();
$("#loader_671_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#671_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_671_<?php echo $count; ?>").one("change", function(){    

   $('#671_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#671_page_<?php echo $count; ?>').html(data);  
           $("#abcd_671_<?php echo $count;?>").show();
        $("#abcd_671_<?php echo $count;?>").fadeOut(5000);
