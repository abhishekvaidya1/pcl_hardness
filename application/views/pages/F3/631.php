...
<?php  $action = array('25', '45', '45', '45', '25','4');
$action2 = array('90', '90', '90', '90');
$action3 = array('103', '103', '103', '103');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="631"  style=" display: none;">
...
<!--// Page Data--->
<div id="631_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_631_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="631_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMDAT - T3 B150 (Item 0631) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_631_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="631" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="a,b,c,d,e,CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="96 875 343" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/123/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/631_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_631_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('a','b','c','d','e','CHILL <br>DEPTH');
                                $cust_spec=array('2 – 25 Min.','2 – 45 Min.','2 – 45 Min.','2 – 45 Min.','2 – 25 Min.','4 – 12 mm<br>From Cam <br>Peak');
                                $work_spec=array('3 – 25 Min.','3 – 45 Min.','3 – 45 Min.','3 – 45 Min.','3 – 25 Min.','4 – 12 mm<br>AT ± 25° <br>From Cam <br>Peak');
                                ...
                                {   $flag=0;
                                    if($i==5){
                                        if($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i] || $mm_val_chunk[$i][$j] > 12)) { $flag=1; }else if($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i])) { $flag=1; }else{ $flag=0; }
                                    }else{
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('ROCKWELL <br/>HARDNESS <br/>- B Scale<br/>(HRB) At 2 <br/>mm from Cast <br/>Surface.','','','','');
                                $b_cust_spec=array('BRG.1 <br>90 - 103','BRG.4 <br>90 - 103','BRG.6 <br>90 - 103','COLLAR <br>90 - 103');
                                $b_work_spec=array('BRG.1 <br>90 - 100','BRG.4 <br>90 - 100','BRG.6 <br>90 - 100','COLLAR <br>90 - 100');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                              ...
                              <tr style="vertical-align: center; text-align: center">
                                  <td class="mytdstyle">CHILL <br>DEPTH</td>
                                <td class="mytdstyle">4 – 12 mm<br>From Cam <br>Peak</td>
                                <td class="mytdstyle">4 – 12 mm<br>AT ± 25° <br>From Cam <br>Peak</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="4">ROCKWELL <br/>HARDNESS <br/>- B Scale<br/>(HRB) At 2 <br/>mm from Cast <br/>Surface.</td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.6 <br>90 - 103</td>
                                <td style=" width:50px;" class="mytdstyle">BRG.6 <br>90 - 100</td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></td>
                                <td  style=" width:50px;"><input type="text" class="form-control b_action_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" > </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img"><img src="Audio/631_cam.png" style="" class=" " ></div></th>
                        ...
                        <input type="text" name="cust_name" value="GMDAT - T3 B150 (Item 0631)" style=" display: none;">
...
<div id="631_page_<?php echo $count; ?>"></div>
<div id="loader_631_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_631_"+<?php echo json_decode($count); ?>).show();
$("#loader_631_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#631_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.631_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#631_page_1_<?php echo json_decode($count); ?>").hide();
$("#631_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_631_<?php echo $count; ?>").one("change", function(){    

   $('#631_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_631_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#631_page_<?php echo $count; ?>').html(data);  
           $("#abcd_631_<?php echo $count;?>").show();
        $("#abcd_631_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_631_<?php echo $count;?>").hide();
//   }
