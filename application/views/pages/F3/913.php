...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="913"  style=" display: none;">
...
<!--// Page Data--->
<div id="913_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_913_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="913_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - 0913 CAMSHAFT<?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_913_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="913" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="98129071FA" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/698/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/913_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_913_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN (5 MM BALL 750 KG LOAD)<br/><img src="Audio/913_brg.png" width="100">','','','','','','','');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;" rowspan="7">BRINELL HARDNESS <br>(5 MM BALL 750 KG LOAD)<br/><img src="Audio/913_brg.png" width="100"></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/913_cam.png" style="" class=" " width="300"></div></th>
                        ...
                        <input type="text" name="cust_name" value="0913 CAMSHAFT" style=" display: none;">
...
<div id="913_page_<?php echo $count; ?>"></div>
<div id="loader_913_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_913_"+<?php echo json_decode($count); ?>).show();
$("#loader_913_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#913_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_913_<?php echo $count; ?>").one("change", function(){    

   $('#913_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#913_page_<?php echo $count; ?>').html(data);  
           $("#abcd_913_<?php echo $count;?>").show();
        $("#abcd_913_<?php echo $count;?>").fadeOut(5000);
