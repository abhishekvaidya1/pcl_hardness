...
<?php  $action = array('45', '5.5', '45', '5', '45','5','40','5','40','5','3.5');
$action2 = array('180', '180', '180');
$action3 = array('230', '230', '230');
$pqrs=['P','Q','R','S','P','Q','R','S','P','Q','R','S']?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="911"  style=" display: none;">
...
<!--// Page Data--->
<div id="911_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_911_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="911_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - 700CC Dicor Engine (Item 0911) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_911_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="911" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,CHILL DEPTH,A,CHILL DEPTH,B,CHILL DEPTH,C,CHILL DEPTH,D,CHILL DEPTH,OIL SEAL CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="5736 0510 7901" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/696/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/911_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_911_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk= array_chunk((array_slice($b_val, 0, 12)), 6);
                                $b_val_chunk3= array_chunk((array_slice($b_val, 12, 12)), 12);
                                $b_val_chunk2= array_chunk((array_slice($b_val, 24, 37)), 7);
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','CHILL DEPTH','A','CHILL DEPTH','B','CHILL DEPTH','C','CHILL DEPTH','D','CHILL DEPTH','OIL SEAL <br/>CHILL DEPTH');
                                $cust_spec=array('5.5 - 45 Min.','‘O’ 45 HRc - 5.5 MM Min.','5.0 - 45 Min.','‘A’ 45 HRc - 5.0 MM Min','5.0 - 45 Min.','‘B’ 45 HRc - 5.0 MM Min','5.0 – 40 Min.','‘C’ 40 HRc – 5.0 MM Min','5.0 – 40 Min.','‘D’ 40 HRc – 5.0 MM Min','3.5 MM Min at 40 HRc (2.00mm + 1.50 mm Machining Allowance)');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS <br/>(10 MM BALL, <br/>3000 KG LOAD)<br/><img src="Audio/911_brg.png" width="100" >','','');
                                $b_cust_spec=array('BRG-1 <br/>180-230','BRG.2<br/>180-230');
                                ...
                                {   $bitflag=0;
                                  ...
                                  <?php                                
                                $b_cust_spec1=array('CAM BHN AT CENTRE-<br/>180-250<br/>(29.50mm +2.00 mm Machining <br/>Allowance =31.50 mm)');
                                for($i=0;$i<count($b_val_chunk3);$i++)
                                {?><tr style="vertical-align: center; text-align: center">                                   
                                   <td class="mytdstyle"><?php echo $b_cust_spec1[$i];?></td>                                   
                                   
                                <?php $bb=1;for($j=0;$j<count($b_val_chunk3[$i]);$j++)    
                                {   $bitflag=0;
                                    if($b_val_chunk3[$i][$j]!="" && ($b_val_chunk3[$i][$j] < 180 || $b_val_chunk3[$i][$j] > 250)){
                                        $bitflag=1;
                                    }else{
                                        $bitflag=0;
                                    }?>                                   
                                    <td style=" width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk3[$i][$j];?>"></center></td>                                    
                                    <?php  $bb++; } ?> <?php }?>
                                 </tr>
                                ...
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" rowspan="2">Slice Rating<br/>6 Min.</td><?php }?>                                   
                                   
                                <?php $bb=1;for($j=0;$j<count($b_val_chunk2[$i]);$j++)    
                                {   $bitflag=0;
                                    if($i==1){
                                        if($b_val_chunk2[$i][$j]!="" && $b_val_chunk2[$i][$j] < 6){
                                            $bitflag=1;
                                        }else{
                                            $bitflag=0;
                                        }
                                    ...
                                    ?>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng<?php if($i==0){ ?>1<?php } ?>_<?php echo $count; ?> mm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:80px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>" <?php if($i==0){ ?>placeholder="L" <?php } ?>></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O</td>
                                   <td class="mytdstyle" >5.5 - 45 Min.</td>                             
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >5.0 - 45 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘A’ 45 HRc - 5.0 MM Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘B’ 45 HRc – 5.0 MM Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >5.0 - 40 Min.</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘C’ 40 HRc – 5.0 MM Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘D’ 40 HRc - 5.0 MM Min</td>
                                 ...
                                 <tr style="vertical-align: center; text-align: center">
                                     <td class="mytdstyle" >OIL SEAL<br/>CHILL DEPTH</td>
                                   <td class="mytdstyle" >3.5 MM Min at 40 HRc (2.00mm + 1.50 mm Machining Allowance)</td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="P"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="Q"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="R"></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action10_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" placeholder="S"></td>
                                </tr>   
                                
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="3">BRINELL HARDNESS (10 MM BALL ,3000 KG LOAD)<br/><img src="Audio/911_brg.png" width="100" ></td>
                                ...
                                <tr>
                                <td  style=" width:50px;" class="mytdstyle">CAM BHN AT CENTRE-<br/>180-250<br/>(29.50mm +2.00 mm Machining<br/>Allowance =31.50 mm) </td>
                                ...
                                <tr>
                                    <td style=" width:80px; vertical-align: middle;" class="mytdstyle" rowspan="2">Slice Rating <br/>6 Min.</td>                                
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="L"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="L"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="L"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="L"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="L"></center> </td>
                                ...
                                <tr>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/911_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - 700CC Dicor Engine (Item 0911)" style=" display: none;">
...
<div id="911_page_<?php echo $count; ?>"></div>
<div id="loader_911_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_911_"+<?php echo json_decode($count); ?>).show();
$("#loader_911_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#911_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('keyup', '.b_action1_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseInt(th) < 180 || parseInt(th) > 250)
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(".page_select_911_<?php echo $count; ?>").one("change", function(){    

   $('#911_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#911_page_<?php echo $count; ?>').html(data);  
           $("#abcd_911_<?php echo $count;?>").show();
        $("#abcd_911_<?php echo $count;?>").fadeOut(5000);
