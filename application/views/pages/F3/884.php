...
<!--// Page Data--->
<div id="884_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_884_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="884_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth - SIMPSON - 1000 Series (Item 0884)</strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_884_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="884" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="PM-A1-109" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/670/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/884_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_884_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                $cust_spec=array('3.0 MM- 475 HV 30 MIN','3.0 MM- 475 HV 30 MIN');
                                ...
                                <td style=" width:50px;" colspan="2"><center><label>CENTRE</label></center></td>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN OR (5 MM BALL , 750 KG LOAD)<br/><img src="Audio/884_brg.png" width="100">','','');
                                $b_cust_spec=array('BRG. 1<br/>229 - 285','BRG. 2<br/>229 - 285','BRG. 3<br/>229 - 285');
                                ...
                                {   $bitflag=0;
                                    if($b_val_chunk[$i][$j]!="" && ($b_val_chunk[$i][$j] < $action2[$i] || $b_val_chunk[$i][$j] > $action3[$i])){
                                     ...
                                     ?>
                                        <td <?php if($j%3==2){ ?> colspan="2" <?php } ?> style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O</td>
                                   <td class="mytdstyle" >3.0 MM- 475 HV 30 MIN</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="3">BRINELL HARDNESS BHN (10 MM BALL ,3000 KG LOAD) OR (5 MM BALL , 750 KG LOAD)<br/><img src="Audio/884_brg.png" width="100"></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/884_cam.png" style="" class=" " width="200"></div></th>
                        ...
                        <input type="text" name="cust_name" value="SIMPSON - 1000 Series (Item 0884)" style=" display: none;">
...
<div id="884_page_<?php echo $count; ?>"></div>
<div id="loader_884_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_884_"+<?php echo json_decode($count); ?>).show();
$("#loader_884_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#884_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_884_<?php echo $count; ?>").one("change", function(){    

   $('#884_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#884_page_<?php echo $count; ?>').html(data);  
           $("#abcd_884_<?php echo $count;?>").show();
        $("#abcd_884_<?php echo $count;?>").fadeOut(5000);
