...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="688"  style=" display: none;">
...
<!--// Page Data--->
<div id="688_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_688_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="688_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - TML - Cub (Item 0688) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_688_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="688" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="2788 0510 0401" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/178/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/688_img.png" style=" display: block;margin-left: auto;margin-right: auto;"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_688_<?php echo $count; ?>">
                            <tr>
                            ...
                            <?php
                                ...
                                $b_val_chunk2= array_chunk((array_slice($b_val, 18, 31)), 7);?>
                            <tr>
                                ...
                                $cust_spec=array('5.5 - 45 Min.','‘O’ 45 HRc - 5.5 MM Min.','5 - 45 Min.','‘A’ 45 HRc - 5 MM Min','5 - 45 Min.','‘B’ 45 HRc - 5 MM Min','5 – 40 Min.','‘C’ 40 HRc –5 MM Min','5 – 40 Min.','‘D’ 40 HRc –5 MM Min','3.5 MM Min at 40 HRc (2.00mm + 1.50 mm Machining Allowance)');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS <br/>(10 MM BALL, <br/>3000 KG LOAD)<br/><img src="Audio/688_brg.png" width="100" >','','');
                                $b_cust_spec=array('BRG-1 <br/>180-230','BRG.2<br/>180-230','CAM BHN AT CENTRE-<br/>180-230<br/>(29.50mm +2.00 mm Machining <br/>Allowance =31.50 mm)');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action<?php if($i==2){ ?>1<?php } ?>_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:80px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php 
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >5 - 45 Min.</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘A’ 45 HRc - 5 MM Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >CHILL DEPTH</td>
                                   <td class="mytdstyle" >‘B’ 45 HRc – 5 MM Min</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="3">BRINELL HARDNESS (10 MM BALL ,3000 KG LOAD)<br/><img src="Audio/688_brg.png" width="100" ></td>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">CAM BHN AT CENTRE-<br/>180-230<br/>(29.50mm +2.00 mm Machining<br/>Allowance =31.50 mm) </td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td  colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:80px;font-size: 16px;" name="b_val[]" ></center></td>                                
                                </tr>
                                <tr>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/688_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="TML - Cub (Item 0688)" style=" display: none;">
...
<div id="688_page_<?php echo $count; ?>"></div>
<div id="loader_688_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_688_"+<?php echo json_decode($count); ?>).show();
$("#loader_688_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#688_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_688_<?php echo $count; ?>").one("change", function(){    

   $('#688_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#688_page_<?php echo $count; ?>').html(data);  
           $("#abcd_688_<?php echo $count;?>").show();
        $("#abcd_688_<?php echo $count;?>").fadeOut(5000);
