...
<?php  $action = array('47', '50', '50', '50', '47','45','45','45','45','45','45','50','50','50','50','50');
$action2 = array('183', '183', '183', '183','183','183','183','183');
$action3 = array('300', '300', '300', '300','300','300','300','300');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="726"  style=" display: none;">
...
<!--// Page Data--->
<div id="726_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_726_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="726_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - MHM - 1.3L EURO 5 (Item 0726) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_726_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="726" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="a,b,c,d,e,f,g,h,m,n,o,k,Hardness At Radius (BETWEEN CAM & STEM),Hardness At Radius (BETWEEN CAM & STEM),Hardness At Radius (BETWEEN CAM & STEM),Hardness At Radius (BETWEEN CAM & STEM)" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="55206897" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/517/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/726_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_726_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('a','b','c','d','e','f','g','h','m','n','o','k','Hardness At Radius<br/>(BETWEEN CAM & STEM)','Hardness At Radius<br/>(BETWEEN CAM & STEM)','Hardness At Radius<br/>(BETWEEN CAM & STEM)','Hardness At Radius<br/>(BETWEEN CAM & STEM)');
                                $cust_spec=array('1.5 - 47 Min','1.5 - 50 Min','1.5 - 50 Min','1.5 - 50 Min','1.5 - 47 Min','1.5 - 45 Min','3.5 - 45 Min','3.5 - 45 Min','3.5 - 45 Min','3.5 - 45 Min','3.5 - 45 Min','3.5 - 50 Min','50 HRC max at <br/>0.5 mm','50 HRC max at <br/>0.5 mm','50 HRC max at <br/>0.5 mm','50 HRC max at <br/>0.5 mm');
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">  
                                    <?php if($i<13){ ?>
                                    <td class="mytdstyle" style="vertical-align: middle;" <?php if($i==12){?> rowspan="4" <?php } ?> ><?php echo $at_point[$i];?></td>                                   
                                    <td class="mytdstyle" style="vertical-align: middle;" <?php if($i==12){?> rowspan="4" <?php } ?> ><?php echo $cust_spec[$i];?></td> 
                                    <?php }?> 
                                <?php $mm=1;for($j=0;$j<count($mm_val_chunk[$i]);$j++)    
                                {   $flag=0;
                                    if($i<12){
                                    if($mm_val_chunk[$i][$j]!="" && $mm_val_chunk[$i][$j] < $action[$i]) { $flag=1; }else{ $flag=0; }}else{
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS(5/750 Kg Load)<br/><img src="Audio/726_brg.png" width="100" >','','','','','','','');
                                $b_cust_spec=array('BRG.1<br>183-300','BRG.2<br>183-300','BRG.3<br>183-300','BRG.4<br>183-300','BRG.5<br>183-300','COLLAR 1<br/>183-300','COLLAR 2<br/>183-300','Pad<br>183-300');
                                for($i=0;$i<count($b_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" rowspan="8"><?php echo $b_point[$i];?></td><?php }?>
                               ...
                               <?php $bb++;}?> <?php }?>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >a</td>
                                   <td class="mytdstyle" >1.5 - 47 Min</td>                             
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                    ...
                                    <td class="mytdstyle">1.5 - 50 Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   ...
                                   <td class="mytdstyle" >1.5 - 45 Min</td>
                                   ...
                                   <td class="mytdstyle" >3.5 - 45 Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                   <td class="mytdstyle" >k</td>
                                   <td class="mytdstyle" >3.5 - 50 Min</td>
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                    <td class="mytdstyle" rowspan="4" style=" vertical-align: middle;">Hardness At Radius <br/>(BETWEEN CAM & STEM)</td>
                                   <td class="mytdstyle" rowspan="4" style=" vertical-align: middle;">50 HRC max at <br/>0.5 mm</td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action12_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                                </tr>
                                <tr style="vertical-align: center; text-align: center">                                
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action13_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                                </tr>
                                <tr style="vertical-align: center; text-align: center">                                
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action14_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                                </tr>
                                <tr style="vertical-align: center; text-align: center">                                
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                   <td style=" width:50px;"><input type="text" class="form-control action15_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                                </tr>
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="8">BRINELL HARDNESS(5/750 Kg Load)<br/><img src="Audio/726_brg.png" width="100" ></td>
                                <td style=" width:50px;" class="mytdstyle">BRG.1<br>183-300</td>
                                ...
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle">BRG.2<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.3<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.4<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.5<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 1<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                    <td style=" width:50px;" class="mytdstyle">COLLAR 2<br/>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">Pad<br>183-300</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/726_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="MHM - 1.3L EURO 5 (Item 0726)" style=" display: none;">
...
<div id="726_page_<?php echo $count; ?>"></div>
<div id="loader_726_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_726_"+<?php echo json_decode($count); ?>).show();
$("#loader_726_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#726_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('keyup', '.b_action_<?php echo $count; ?>', function (e) {
    ...
    if(parseInt(th) < 183 || parseInt(th) > 300)
...
$(document).on('keyup', '.action3_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseInt(th) < 50 || parseInt(th) > 58 )
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(document).on('keyup', '.action12_<?php echo $count; ?>', function (e) {
    var th=$(this).val();
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseFloat(th) > 50)
...
$(document).on('keyup', '.action13_<?php echo $count; ?>', function (e) {
    var th=$(this).val();
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseFloat(th) > 50)
...
$(document).on('keyup', '.action14_<?php echo $count; ?>', function (e) {
    var th=$(this).val();
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseFloat(th) > 50)
...
$(document).on('keyup', '.action15_<?php echo $count; ?>', function (e) {
    var th=$(this).val();
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseFloat(th) > 50)
...
$(".page_select_726_<?php echo $count; ?>").one("change", function(){    

   $('#726_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#726_page_<?php echo $count; ?>').html(data);  
           $("#abcd_726_<?php echo $count;?>").show();
        $("#abcd_726_<?php echo $count;?>").fadeOut(5000);
