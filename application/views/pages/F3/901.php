...
<?php  $action = array('47', '42', '42', '40', '241', '241', '241', '241');
$action2 = array('241', '229', '229');
$action3 = array('302', '285', '285');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="901"  style=" display: none;">
...
<!--// Page Data--->
<div id="901_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_901_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="901_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - M & M - D15 In.(Item 0901) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_901_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="901" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="0310ABF00470N" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/687/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/901_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_901_<?php echo $count; ?>">
                            <tr>
                                <td rowspan="3" style=" vertical-align:  middle; text-align: center;width: 60px;">AT POINT</td>
                                <td rowspan="2" colspan="2" style=" vertical-align:  middle; text-align: center;width: 60px;">CUSTOMER SPEC.</td>                                
                            ...
                            <tr>
                                ...
                                <?php $l++;} ?></tr>
                                <tr>
                                    <td style=" vertical-align:  middle; text-align: center;" colspan="2">MM-HRc</td>                              
                                ...
                                <?php 
                                $at_point=array('AT POINT O','AT POINT A','AT POINT B','AT POINT C','BRINELL<br/>HARDNESS<br/>(5/750 KG LOAD)');
                                $cust_spec=array('5.5–47 HRc MIN.','4.5–42 HRc MIN.','4.5–42 HRc MIN.','4.5–40 HRc MIN.','CAM CORE GRAY ZONE 12 MM MIN');
                                
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">                                    
                                    
                                    <?php if($i==4) { ?>
                                    <td class="mytdstyle" style="vertical-align: middle;" rowspan="4"><?php echo $at_point[$i];?></td>                                   
                                    <td class="mytdstyle" style="vertical-align: middle; width: 100px;" rowspan="4"><?php echo $cust_spec[$i];?></td> 
                                    <td class="mytdstyle" style="vertical-align: middle; width: 80px;" rowspan="4">241-302</td> <?php }  else if($i<4){?>
                                    <td class="mytdstyle" style="vertical-align: middle;"><?php echo $at_point[$i];?></td>                                   
                                    <td class="mytdstyle" style="vertical-align: middle; width: 100px;" colspan="2"><?php echo $cust_spec[$i];?></td><?php } ?> 
                                <?php $mm=1;for($j=0;$j<count($mm_val_chunk[$i]);$j++)    
                                {   $flag=0;
                                    if($i>=4){
                                        if($mm_val_chunk[$i][$j]!="" && ($mm_val_chunk[$i][$j] < $action[$i] || $mm_val_chunk[$i][$j] > 302)) { $flag=1; }else{ $flag=0; }
                                    }else{
                                        if($mm_val_chunk[$i][$j]!="" && $mm_val_chunk[$i][$j] < $action[$i]) { $flag=1; }else{ $flag=0; }
                                    }?>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px;font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo $mm_val_chunk[$i][$j];?>"></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 <?php 
                                $b_point=array('BRINELL HARDNESS AT CENTRE(10/3000 KG LOAD)<br/><img src="Audio/901_brg.png" width="100">','','','');
                                $b_cust_spec=array('SHAFT AREA','BRG. 1','REAR END');
                                $b_work_spec=array('241-302','229-285','229-285');
                                for($i=0;$i<count($b_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" rowspan="3"><?php echo $b_point[$i];?></td><?php }?>
                                    <td class="mytdstyle" style="vertical-align: middle;"><?php echo $b_cust_spec[$i];?></td>                                   
                                    <td class="mytdstyle" style="vertical-align: middle;"><?php echo $b_work_spec[$i];?></td>                                   
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >AT POINT O</td>
                                 <td class="mytdstyle" colspan="2">5.5 – 47 HRc MIN.</td>                             
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle">AT POINT A</td>
                                <td class="mytdstyle" colspan="2">4.5 – 42 HRc MIN.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" >AT POINT B</td>
                                <td class="mytdstyle" colspan="2"> 4.5 – 42 HRc MIN.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" >AT POINT C</td>
                                <td class="mytdstyle" colspan="2">4.5 – 40 HRc MIN.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align: middle;" rowspan="4">BRINELL <br/>HARDNESS<br/>(5/750 KG LOAD)</td>
                                <td class="mytdstyle" style=" width: 100px; vertical-align: middle;" rowspan="4">CAM CORE GRAY ZONE 12 MM MIN</td>
                                <td class="mytdstyle" style="width: 80px; vertical-align: middle;" rowspan="4">241-302</td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                             </tr>
                             <tr style="vertical-align: center; text-align: center">
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action5_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                             </tr>
                             <tr style="vertical-align: center; text-align: center">
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action6_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                             </tr>
                             <tr style="vertical-align: center; text-align: center">
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style=" width:50px; vertical-align: middle;"><input type="text" class="form-control action7_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>                                
                             </tr>
                                                    
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="3">BRINELL HARDNESS AT CENTRE(10/3000 KG LOAD)<br/><img src="Audio/901_brg.png" width="100"></td>
                                <td style=" width:50px; vertical-align: middle;" class="mytdstyle">SHAFT AREA</td>
                                <td class="mytdstyle" >241-302</td>
                                ...
                                <tr>                                
                                <td style=" width:50px; vertical-align: middle;" class="mytdstyle">BRG. 1</td>
                                <td class="mytdstyle" style="vertical-align: middle;">229-285</td>
                                ...
                                <tr>
                                <td style="vertical-align: middle; width:50px;" class="mytdstyle">REAR END</td>
                                <td class="mytdstyle" style="vertical-align: middle;">229-285</td>
                                <td colspan="2" style="vertical-align: middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style="vertical-align: middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style="vertical-align: middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/901_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="M & M - D15 In.(Item 0901)" style=" display: none;">
...
<div id="901_page_<?php echo $count; ?>"></div>
<div id="loader_901_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_901_"+<?php echo json_decode($count); ?>).show();
$("#loader_901_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#901_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('keyup', '.b_action_<?php echo $count; ?>', function (e) {
    ...
    if(parseInt(th) < 241 || parseInt(th) > 302)
...
$(document).on('keyup', '.b_action1_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseInt(th) < 229 || parseInt(th) > 285)
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(".page_select_901_<?php echo $count; ?>").one("change", function(){    

   $('#901_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#901_page_<?php echo $count; ?>').html(data);  
           $("#abcd_901_<?php echo $count;?>").show();
        $("#abcd_901_<?php echo $count;?>").fadeOut(5000);
