...
<?php  $action = array('45', '7', '45', '5.5','45','5.5','350','350');
...
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="891"  style=" display: none;">
...
<!--// Page Data--->
<div id="891_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_891_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="891_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong> Hardness & Chill Depth  - ESCORT - Farmtrack AVL New FT (Item 0891)<?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_891_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="891" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,CHILL DEPTH,A,CHILL DEPTH,B,CHILL DEPTH,C,D" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="D10421880" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/677/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/891_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_891_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','CHILL DEPTH','A','CHILL DEPTH','B','CHILL DEPTH','C','D');
                                $cust_spec=array('3 MM – 45 HRC MIN','7 MM – MIN 400 Hv','3 MM – 45 HRC MIN','5.5 MM - MIN 400 Hv','3 MM – 45 HRC MIN','5.5 MM – MIN 400 Hv','3.5 MM - 350 Hv MIN','3.5 MM - 350 Hv MIN');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('HARDNESS AT FILLET RADIUS B-B & C-C','BRINELL HARDNESS BHN (10 MM BALL ,3000 KG LOAD)<br/><img src="Audio/891_brg.png" width="100">','');
                                $b_cust_spec=array('350 Hv MAX','BRG 1<br/>229-302','BRG 4<br/>229-302');
                                for($i=0;$i<count($b_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;"><?php echo $b_point[$i];?></td><?php }else if($i==1){ ?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" rowspan="2"><?php echo $b_point[$i];?></td><?php }?>
...
<!--                                    <td style=" vertical-align:  middle; text-align: center;">MM-HRc</td>                                -->
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O</td>
                                   <td class="mytdstyle" >3 MM - 45 HRC MIN.</td>                             
                                ...
                                <td class="mytdstyle">7 MM – MIN 400 Hv</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" >CHILL DEPTH</td>
                                <td class="mytdstyle" >5.5 MM – MIN 400 Hv</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" >3.5 MM - 350 Hv MIN</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style=" vertical-align: middle; text-align: center;" >HARDNESS AT FILLET RADIOUS B-B & C-C</td>
                                <td class="mytdstyle" style=" vertical-align: middle; text-align: center;">350 Hv MAX</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>    
                            </tr>
                             
                             
                                                             
                            <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="2">BRINELL HARDNESS <br>BHN (10 MM BALL ,3000 KG LOAD) <br/><img src="Audio/891_brg.png" width="100"></td>
                                <td style=" width:50px;  vertical-align: middle; text-align: center;" class="mytdstyle">BRG 1<br/>229-302</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>    
                            </tr>
                            <tr>                                
                                <td style=" width:50px;  vertical-align: middle; text-align: center;" class="mytdstyle"> BRG 4<br/>229-302</td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px; vertical-align: middle; text-align: center;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/891_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="ESCORT - Farmtrack AVL New FT (Item 0891)" style=" display: none;">
...
<div id="891_page_<?php echo $count; ?>"></div>
<div id="loader_891_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_891_"+<?php echo json_decode($count); ?>).show();
$("#loader_891_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#891_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_891_<?php echo $count; ?>").one("change", function(){    

   $('#891_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#891_page_<?php echo $count; ?>').html(data);  
           $("#abcd_891_<?php echo $count;?>").show();
        $("#abcd_891_<?php echo $count;?>").fadeOut(5000);
