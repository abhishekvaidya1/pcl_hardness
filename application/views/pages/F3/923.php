...
$action2 = array('197', '197', '197','197','197','197','197','197');
$action3 = array('241', '241', '241', '241','241','241','241','241');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="923"  style=" display: none;">
...
<!--// Page Data--->
<div id="923_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_923_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="923_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - LWI - Improved Kappa 4 In. (Item 0923) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_923_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="923" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="24210-08000" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/709/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/923_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_923_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN( 5/750 Kg Load )<br/><img src="Audio/923_brg.png" width="100" >','','','','','','','');
                                $b_cust_spec=array('BRG 1 <br/>197 - 241','BRG 2 <br/>197 - 241','BRG 3 <br/>197 - 241','BRG 4 <br/>197 - 241','BRG 5<br/>197 - 241','BRG 6<br/>197 - 241','Collar 1<br/>197 - 241','Collar 2<br/>197 - 241');
                             ...
                             <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="8">BRINELL HARDNESS BHN( 5/750 Kg Load )<br/><img src="Audio/823_brg.png" width="100" ></td>                                                         
                             ...
                             <tr>
                                ...
                                <tr>
                                <td style=" width:80px;" class="mytdstyle">BRG. 6 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/923_cam.png" width="300" height="230"></div></th>
                        ...
                        <input type="text" name="cust_name" value="LWI - Improved Kappa 4 In. (Item 0923)" style=" display: none;">
...
<div id="923_page_<?php echo $count; ?>"></div>
<div id="loader_923_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_923_"+<?php echo json_decode($count); ?>).show();
$("#loader_923_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#923_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.923_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#923_page_1_<?php echo json_decode($count); ?>").hide();
$("#923_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(".page_select_923_<?php echo $count; ?>").one("change", function(){    

   $('#923_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_923_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#923_page_<?php echo $count; ?>').html(data);  
           $("#abcd_923_<?php echo $count;?>").show();
        $("#abcd_923_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_923_<?php echo $count;?>").hide();
//   }
