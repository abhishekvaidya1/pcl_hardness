...
<?php  $action = array('500', '400', '400', '350', '400','350','400','350','5.5','3.5');
$action2 = array('197', '197', '197', '197','197','197','197','197','201');
$action3 = array('241', '241', '241', '241','241','241','241','241','262');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="832"  style=" display: none;">
...
<!--// Page Data--->
<div id="832_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_832_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="832_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - LWI - KAPPA-4 Ex. (Item 0832) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_832_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="832" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,O,A,A,B,B,C,C,Effective chill Depth At peak,Effective chill Depth At A B & C" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="24210-03050H" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/617/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="item_img"><img src="Audio/832_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_832_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php $l++;} ?></tr>
                                <tr>
                                <td style=" vertical-align:  middle; text-align: center;">MM-Hv</td>                              
                                ...
                                <?php 
                                $at_point=array('O','O','A','A','B','B','C','C','Effective chill Depth<br/>At peak','Effective chill Depth<br/>At A B & C');
                                $cust_spec=array('2.00 – 500 Min','5.5 – 400 Min','2.00 – 400 Min','3.5 – 350 Min','2.00 - 400 Min','3.5 - 350 Min','2.00 - 400 Min','3.5 - 350 Min','5.5 MM','3.5 MM');
                                for($i=0;$i<count($mm_val_chunk);$i++)
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i<8){ if($i%2==0){?>
                                    <td class="mytdstyle" rowspan="2" style="vertical-align: middle;"><?php echo $at_point[$i];?></td>
                                    <?php } }else {?>
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN( 5/750 Kg Load )<br/><img src="Audio/832_brg.png" width="100" >','','','','','','','','');
                                $b_cust_spec=array('Front End <br/>197 - 241','BRG 1 <br/>197 - 241','BRG 2 <br/>197 - 241','BRG 3 <br/>197 - 241','BRG 4 <br/>197 - 241','BRG 5<br/>197 - 241','Collar 1<br/>197 - 241','Collar 2<br/>197 - 241','Pad <br/>201 - 262');
                                ...
                                {   $bitflag=0;
                                    ...
                                    ?>
                                   <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                               <?php $bb++;}?> <?php }?>
                                 </tr>
                                 <?php
                                 $a=array();
                                ...
                                {?><tr style="vertical-align: center; text-align: center">
                                    <?php if($i==0){?><td class="mytdstyle" style="text-align: center; vertical-align: middle;" colspan="2" rowspan="3">PAD BHN</td><?php }?>
                                                                      
                                <?php $bb=1;for($j=0;$j<count($b_val_chunk2[$i]);$j++)    
                                {
                                    $padflag=0;
                                    if($b_val_chunk2[$i][$j]!="" && ($b_val_chunk2[$i][$j] < 201 || $b_val_chunk2[$i][$j] > 262)){
                                        $padflag=1;
                                    }else{
                                        $padflag=0;
                                    }
                                    ?>
                                    <td colspan="2" style="width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; <?php if($padflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk2[$i][$j];?>" placeholder="<?php echo $a[$i][$j];?>"></center></td>
                               <?php $bb++; }?> <?php }?>
                                 </tr>
                                 <tr>
                                ...
                                // IF DATA NOT EXIST
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                    <td style=" vertical-align:  middle; text-align: center;">MM-Hv</td>                                
                                    <td style=" width:50px;"><input type="text" class="form-control c_1_<?php echo $count; ?> " name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_2_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_3_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_4_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_5_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_6_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_7_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_8_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_9_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_10_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_11_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                                    <td style=" width:50px;"><input type="text" class="form-control c_12_<?php echo $count; ?>"  name="c_val[]" style=" width:50px;font-size: 16px;" placeholder="C-"></div></td>
                            </tr>
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" rowspan="2" style="vertical-align:middle">'O'</td>
                                   <td class="mytdstyle" style="vertical-align:middle">2.00 - 500 Min</td>                             
                                ...
                                <td class="mytdstyle">5.5 – 400 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" rowspan="2" style="vertical-align:middle">'A'</td>
                                <td class="mytdstyle" style="vertical-align:middle">2.00 – 400 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle">3.5 – 350 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" rowspan="2" style="vertical-align:middle">'B'</td>
                                <td class="mytdstyle" style="vertical-align:middle">2.00 - 400 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" rowspan="2" style="vertical-align:middle">'C'</td>
                                <td class="mytdstyle" style="vertical-align:middle">2.00 - 400 Min</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">'Effective chill Depth<br/>At Peak'</td>
                                <td class="mytdstyle" style="vertical-align:middle">5.5 MM</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" style="vertical-align:middle">'Effective chill Depth<br/>At A B & C'</td>
                                <td class="mytdstyle" style="vertical-align:middle">3.5 MM</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="9">BRINELL HARDNESS BHN( 5/750 Kg Load )<br/><img src="Audio/832_brg.png" width="100" ></td>
                                <td style=" width:60px;" class="mytdstyle">Front End <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>                           
                                </tr>
                                <tr>                                
                                <td style=" width:60px;" class="mytdstyle">BRG. 1 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">BRG 2 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">BRG. 3 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">BRG. 4 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">BRG. 5 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">Collar 1 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">Collar 2 <br/>197 - 241</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:60px;" class="mytdstyle">Pad <br/>201 - 262</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                </tr>
                                <tr>
                                    <td style=" width:80px; vertical-align: middle;" class="mytdstyle " colspan="2" rowspan="3">PAD BHN</td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="1"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="4"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="1"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="4"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="1"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="4"></center> </td>
                                ...
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="2"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="5"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="2"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="5"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="2"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="5"></center> </td>
                                ...
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="3"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="6"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="3"></center></td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="6"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="3"></center> </td>
                                <td colspan="2" style=" width:80px;"><center><input type="text" class="form-control vng_rng_<?php echo $count; ?>" style="width:90px;font-size: 16px; " name="b_val[]" placeholder="6"></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/832_cam.png" width="70%"></div></th>
                        ...
                        <input type="text" name="cust_name" value="LWI - KAPPA-4 Ex. (Item 0832)" style=" display: none;">
...
<div id="832_page_<?php echo $count; ?>"></div>
<div id="loader_832_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_832_"+<?php echo json_decode($count); ?>).show();
$("#loader_832_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#832_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('click', '.832_page_1_<?php echo json_decode($count); ?>', function (e) {
$("#832_page_1_<?php echo json_decode($count); ?>").hide();
$("#832_page_2_<?php echo json_decode($count); ?>").show();
});
...
$(document).on('keyup', '.b_action_<?php echo $count; ?>', function (e) {
    ...
    if(parseInt(th) < 197 || parseInt(th) > 241)
...
$(document).on('keyup', '.vng_rng_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseInt(th) < 201 || parseInt(th) > 262)
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(".page_select_832_<?php echo $count; ?>").one("change", function(){    

   $('#832_page_1_<?php echo $count; ?>').remove();
...
//    beforeSend: function() {
//              $("#abcd_832_<?php echo $count;?>").show();
//           },
    success: function(data){
      $('#832_page_<?php echo $count; ?>').html(data);  
           $("#abcd_832_<?php echo $count;?>").show();
        $("#abcd_832_<?php echo $count;?>").fadeOut(5000);
           
      }
//              complete:function(data){
//    // Hide image container
//    $("#abcd_832_<?php echo $count;?>").hide();
//   }
