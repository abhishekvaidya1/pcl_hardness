...
<?php  $action = array('50', '50', '50', '48', '48', '3');
$action2 = array('200', '200', '200', '200','200','200','200');
$action3 = array('285', '285', '285', '285','285','285','285');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="817"  style=" display: none;">
...
<!--// Page Data--->
<div id="817_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_817_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="817_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - GMK - 18 XER (Item 0817) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_817_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="817" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="ZONE 1 O,ZONE 1 A At 85º,ZONE 1 B At 85º,ZONE 2 C,ZONE 2 D,CHILL DEPTH" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/016/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/817_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_817_<?php echo $count; ?>">
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('ZONE 1 <br/>O','ZONE 1 <br/>A  At 85°','ZONE 1 <br/>B At 85°',' ZONE 2 <br/>C',' ZONE 2 <br/>D','CHILL DEPTH');
                                $cust_spec=array('02 – 50 Min.','02 – 50 Min.','02 – 50 Min.','02 – 48 Min.','02 – 48 Min.','3 mm Min<br>at peak ± 20°');
                                $work_spec=array('03 – 50 Min.','03 – 50 Min.','03 – 50 Min.','03 – 48 Min.','03 – 48 Min.','3 mm Min<br> All Over');
                                ...
                                <?php $mm++;} ?> <?php }?>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL<br/>HARDNESS<br/>(5/750 Kg Load<br/><img src="Audio/817_brg.png" width="80">','','','','','','','');
                                $b_cust_spec=array('BRG.1 <br/>200 - 285','BRG.3 <br/>200 - 285','BRG.4 <br/>200 - 285','BRG.6 <br/>200 - 285','COLLAR 1 <br/>200 - 285','COLLAR 2 <br/>200 - 285','COLLAR 3 <br/>200 - 285');
                                $b_work_spec=array('BRG.1 <br/>215 - 278','BRG.3 <br/>215 - 278','BRG.4 <br/>215 - 278','BRG.6 <br/>215 - 278','COLLAR 1 <br/>215 - 278','COLLAR 2 <br/>215 - 278','COLLAR 3 <br/>215 - 278');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >ZONE 1 <br/>O</td>
                                   <td class="mytdstyle" >02 – 50 Min.</td>                             
                                   <td class="mytdstyle" >03 – 50 Min.</td>                             
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle">ZONE 1 <br/>A At 85°</td>
                                <td class="mytdstyle">02 – 50 Min.</td>
                                <td class="mytdstyle">03 – 50 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" >ZONE 1 <br/>B At 85°</td>
                                <td class="mytdstyle" >02 – 50 Min.</td>
                                <td class="mytdstyle" >03 – 50 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" >02 – 48 Min.</td>
                                <td class="mytdstyle" >03 – 48 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle" >ZONE 2 <br/>D</td>
                                <td class="mytdstyle" >02 – 48 Min.</td>
                                <td class="mytdstyle" >03 – 48 Min.</td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <td class="mytdstyle" >3  mm Min<br>at peak + 20°</td>
                                <td class="mytdstyle" >3  mm Min<br>All Over</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="7">BRINELL <br/>HARDNESS<br/>(5/750 Kg Load)<br/><img src="Audio/817_brg.png" width="80" ></td>
                                <td style=" width:50px;" class="mytdstyle">BRG.1 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">BRG.1 <br/>215 - 278</td>
                                ...
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle">BRG.3 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">BRG.3 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.4 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">BRG.4 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG.6 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">BRG.6 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 1 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 1 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 2 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 2 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 3 <br/>200 - 285</td>
                                <td style=" width:50px;" class="mytdstyle">COLLAR 3 <br/>215 - 278</td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/817_cam.png" style="" class=" " width="200"></div></th>
                        ...
                        <input type="text" name="cust_name" value="GMK - 18 XER (Item 0817)" style=" display: none;">
...
<div id="817_page_<?php echo $count; ?>"></div>
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#817_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_817_<?php echo $count; ?>").one("change", function(){    

   $('#817_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#817_page_<?php echo $count; ?>').html(data);  
           $("#abcd_817_<?php echo $count;?>").show();
        $("#abcd_817_<?php echo $count;?>").fadeOut(5000);
