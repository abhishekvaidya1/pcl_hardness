...
$action2 = array('229', '241', '241');
$action3 = array('285', '302', '302');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="902"  style=" display: none;">
...
<!--// Page Data--->
<div id="902_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_902_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="902_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - M & M - D15 Ex.(Item 0902) - <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body"> 
                    <div id="abcd_902_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="902" readonly="" style=" display: none;">                                
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="0310ABF00480N" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/688/101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/902_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="70%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_902_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('AT POINT O','AT POINT A','AT POINT B','AT POINT C','BRINELL HARDNESS(5/750 KG LOAD)');
                                ...
                                {?><tr style="vertical-align: center; text-align: center">  
                                    ...
                                    <td class="mytdstyle" style="vertical-align: middle; width: 100px;" rowspan="4">241-302</td> <?php }  else if($i<4){?>
                                ...
                                <td style="vertical-align: middle; width:50px;"><input type="text" class="form-control action<?php echo $i."_".$count;?> mm_<?php echo $mm;?>_<?php echo $count; ?> <?php if($flag==1){?> myClass <?php }?>" style="width:50px;font-size: 16px; <?php if($flag==1){?> background-color:red; color:black; <?php }?>" name="mm_val[]" value="<?php echo $mm_val_chunk[$i][$j];?>"></td>
                                <?php $mm++;} ?> <?php }?>
                                 </tr>
                                 <?php 
                                $b_point=array('BRINELL HARDNESS AT CENTRE(10/3000 KG LOAD)<br/><img src="Audio/902_brg.png" width="100">','','');
                                $b_cust_spec=array('BRG. 1','SHAFT AREA-1<font color="#ffffff">2</font>','SHAFT AREA-2');
                                $b_work_spec=array('229-285','241-302','241-302');
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" rowspan="4" style="vertical-align:middle;">BRINELL HARDNESS(5/750 KG LOAD)</td>
                                <td class="mytdstyle" style="vertical-align:middle; width: 100px;" rowspan="4">CAM CORE GRAY ZONE 12 MM MIN</td>
                                <td class="mytdstyle" style="vertical-align:middle; width: 80px;" rowspan="4">241-302</td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_10_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_11_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                                <td style="vertical-align:middle; width:50px;"><input type="text" class="form-control action4_<?php echo $count; ?> mm_12_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="mm_val[]" ></td>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="3">BRINELL HARDNESS AT CENTRE(10/3000 KG LOAD)<br/><img src="Audio/902_brg.png" width="100" ></td>
                                <td style="vertical-align:middle; width:50px;" class="mytdstyle">BRG. 1</td>
                                ...
                                <tr>                                
                                    <td style="vertical-align:middle; width:50px;" class="mytdstyle">SHAFT AREA-1<font color="#ffffff">2</font></td>
                                <td class="mytdstyle" style="vertical-align:middle;">241-302</td>
                                ...
                                <tr>
                                <td style="vertical-align:middle; width:50px;" class="mytdstyle">SHAFT AREA-2</td>
                                <td class="mytdstyle" style="vertical-align:middle;">241-302</td>
                                <td colspan="2" style="vertical-align:middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style="vertical-align:middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td colspan="2" style="vertical-align:middle; width:50px;"><center><input type="text" class="form-control b_action1_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:90px;font-size: 16px;" name="b_val[]" ></center></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/902_cam.png" style="" class=" " width="400"></div></th>
                        ...
                        <input type="text" name="cust_name" value="M & M - D15 Ex.(Item 0902)" style=" display: none;">
...
<div id="902_page_<?php echo $count; ?>"></div>
<div id="loader_902_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
$("#loader_902_"+<?php echo json_decode($count); ?>).show();
$("#loader_902_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#902_1_"+<?php echo $count; ?>).serialize(),
...
$(".page_select_902_<?php echo $count; ?>").one("change", function(){    

   $('#902_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#902_page_<?php echo $count; ?>').html(data);  
           $("#abcd_902_<?php echo $count;?>").show();
        $("#abcd_902_<?php echo $count;?>").fadeOut(5000);
