...
<?php  $action = array('475', '475');
$action2 = array('229', '229', '229','229');
$action3 = array('285', '285', '285','285');?>
<!-- Page Data--->
<input class="form-control count_item_p_<?php echo $count; ?>"  value="<?php echo $count; ?>"  style=" display: none;">
<input class="form-control item_p_<?php echo $count; ?>" name="item"  value="879"  style=" display: none;">
...
<!--// Page Data--->
<div id="879_page_1_<?php echo $count; ?>">
    <table style=" border:  none; width: 250px;"><tr><td><label>Select Page No.</label></td><td><select class=" form-control page_select_879_<?php echo $count; ?>" style=" width:100px;">
...
<form class="form-horizontal" action="#" id="879_1_<?php echo $count; ?>">
    <div class="page-content-wrap" id="postdata">
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hardness & Chill Depth  - SIMPSON - 14 SG (Item 0879) <?php echo $heat; ?>   Page No - <?php echo $page_no; ?></strong> </h3>
                    </div>
                    <div class="panel-body">
                    <div id="abcd_879_<?php echo $count;?>" style="margin-left: 500px;  position: absolute; width: 100px; display: none;"><img src="loader.gif" style=" width: 150px;"></div>
                            <div class="row">
                            <div class="col-md-6">
                                <input class="form-control item" name="item" required="" value="879" readonly="" style=" display: none;">                                
                                <input class="form-control " name="at_point_name"  value="O,LIFT PUMP ECCENTRIC" readonly="" style=" display: none;">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">                                        
                                            <input type="text" name="part_no" class="form-control part_no" required="" value="-" readonly="" style="color:#000;">
                                            <?php
                                            if (@$main_data->c_date) {?>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" name="qa_ref_no" class="form-control qa_ref_no" required="" value="PCR/IR/665 /101" readonly="" style="color:#000;">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="item_img"><img src="Audio/879_img.png" style=" display: block;margin-left: auto;margin-right: auto;" width="75%"></div>
                    </div>
                </div>
            </div>
        </div>                   
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="overflow-x:auto;overflow-y:auto;border: 0px;">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table_879_<?php echo $count; ?>">
                            <tr>
                            ...
                            <tr>
                                ...
                                <?php 
                                $at_point=array('O','LIFT PUMP ECCENTRIC');
                                $cust_spec=array('2.5 MM  - 475 HV 30 MIN','2.5 MM  - 475 HV 30 MIN');
                                ...
                                <td style=" width:50px;" class="mytdstyle"></td>
                                <td style=" width:50px;"><center><label>COPE</label></center></td>
                                <td style=" width:50px;"><center><label>DRAG</label></center></td>
                                <td style=" width:50px;" colspan="2"><center><label>CENTRE</label></center></td>
                                <td style=" width:50px;"><center><label>COPE</label></center></td>
                                <td style=" width:50px;"><center><label>DRAG</label></center></td>
                                <td style=" width:50px;" colspan="2"><center><label>CENTRE</label></center></td>
                                <td style=" width:50px;"><center><label>COPE</label></center></td>
                                ...
                                <td style=" width:50px;" colspan="2"><center><label>CENTRE</label></center></td>
                                 ...
                                 <?php 
                                $b_point=array('BRINELL HARDNESS BHN(10 MM BALL ,3000 KG LOAD) OR (5 MM BALL , 750 KG LOAD)<br/><img src="Audio/879_brg1.png" width="110">','','','','');
                                $b_cust_spec=array('FRONT END<br/>229 - 285','BRG 1<br/>229 - 285','BRG 2<br/>229 - 285','BRG 3<br/>229 - 285');
                                ...
                                {   $bitflag=0;
                                    if($b_val_chunk[$i][$j]!="" && ($b_val_chunk[$i][$j] < $action2[$i] || $b_val_chunk[$i][$j] > $action3[$i])){
                                     ...
                                     ?>
                                   <td style=" width:50px;" <?php if($j%3==2){ ?> colspan="2" <?php } ?>><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_<?php echo $bb;?>_<?php echo $count; ?>" style="width:50px; font-size: 16px; <?php if($bitflag==1){?> background-color:red; color:black; <?php }?>" name="b_val[]" value="<?php echo $b_val_chunk[$i][$j];?>"></center></td>
                                    <?php 
                                    $bb++;}?> <?php }?>
                                 </tr>
                             ...
                             <tr style="vertical-align: center; text-align: center">
                                 <td class="mytdstyle" >O</td>
                                   <td class="mytdstyle" >2.5 MM  - 475 HV 30 MIN</td>                             
                                ...
                                <tr style="vertical-align: center; text-align: center">
                                <td class="mytdstyle">LIFT PUMP ECCENTRIC</td>
                                <td class="mytdstyle">2.5 MM  - 475 HV 30 MIN</td>
                                ...
                                <tr>
                                <td style="text-align: center; vertical-align: middle;" rowspan="6">BRINELL HARDNESS BHN(10 MM BALL ,3000 KG LOAD)OR (5 MM BALL , 750 KG LOAD)<br/><img src="Audio/879_brg1.png" width="110"></td>
                                <td style=" width:50px;" class="mytdstyle">FRONT END <br>229 - 285</td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_5_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_6_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_7_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_8_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_9_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                </tr>
                                <tr>                                
                                <td style=" width:50px;" class="mytdstyle">BRG 1<br>229 - 285</td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG 2<br>229 - 285</td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                                ...
                                <tr>
                                <td style=" width:50px;" class="mytdstyle">BRG 3<br>229 - 285</td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_1_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_2_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;" colspan="2"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_3_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center></td>
                                <td style=" width:50px;"><center><input type="text" class="form-control b_action_<?php echo $count; ?> mmm_4_<?php echo $count; ?>" style="width:50px;font-size: 16px;" name="b_val[]" ></center> </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th><div id="item_img" ><img src="Audio/879_cam.png" style="" class=" " width="200"></div></th>
                        ...
                        <input type="text" name="cust_name" value="SIMPSON - 14 SG (Item 0879)" style=" display: none;">
...
<div id="879_page_<?php echo $count; ?>"></div>
<div id="loader_879_<?php echo $count;?>" style="margin-left: 500px; margin-top: 800px; position: absolute; width: 100px; display:  none;"><img src="loading.gif" style=" width: 150px;"></div>
...
var mmm1=$('.mmm_1_<?php echo $count; ?>').hasClass('myClass');
var mmm2=$('.mmm_2_<?php echo $count; ?>').hasClass('myClass');
var mmm3=$('.mmm_3_<?php echo $count; ?>').hasClass('myClass');
if(m1==true){
...
var mmm4=$('.mmm_4_<?php echo $count; ?>').hasClass('myClass');
var mmm5=$('.mmm_5_<?php echo $count; ?>').hasClass('myClass');
var mmm6=$('.mmm_6_<?php echo $count; ?>').hasClass('myClass');
if(m5==true){
...
var mmm7=$('.mmm_7_<?php echo $count; ?>').hasClass('myClass');
var mmm8=$('.mmm_8_<?php echo $count; ?>').hasClass('myClass');
var mmm9=$('.mmm_9_<?php echo $count; ?>').hasClass('myClass');
if(m9==true){
...
$("#loader_879_"+<?php echo json_decode($count); ?>).show();
$("#loader_879_"+<?php echo json_decode($count); ?>).fadeOut(5000);
...
$.ajax({
    ...
    cache: false,
    async: false,
    data:$("#879_1_"+<?php echo $count; ?>).serialize(),
...
$(document).on('keyup', '.action2_<?php echo $count; ?>', function (e) {
    ...
    var $this = $(this);
    $this.val($this.val().replace(/[^\d.]/g, ''));
    if(parseInt(th) <30 || parseInt(th) > 475  )
    {   $(this).css("color", "black");  
        $(this).css("background-color", "red"); 
        $(this).addClass('myClass');
    }else
...
$(".page_select_879_<?php echo $count; ?>").one("change", function(){    

   $('#879_page_1_<?php echo $count; ?>').remove();
 ...
 var count_item=$('.count_item_p_<?php echo $count; ?>').val();
  ...
  $.ajax({
    ...
    success: function(data){
      $('#879_page_<?php echo $count; ?>').html(data);  
           $("#abcd_879_<?php echo $count;?>").show();
        $("#abcd_879_<?php echo $count;?>").fadeOut(5000);
